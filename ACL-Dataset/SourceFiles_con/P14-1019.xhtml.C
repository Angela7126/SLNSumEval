...
The method is essentially equivalent to linear programming relaxation approaches
      ...
      <div class="ltx_para" id="S2.p3">
       <p class="ltx_p">
        ...
        [8, 15, 32]
        . Our work builds on one such approach — SampleRank
        [32]
...
(4)
       ...
       <div class="ltx_para" id="S3.SS3.p3">
        ...
        s⁢(x(i),y)-s⁢(x(i),y′)≥E⁢r⁢r⁢(y′)-E⁢r⁢r⁢(y)
...
(5)
       ...
       <div class="ltx_para" id="S3.SS3.p5">
        min||θ-θt||2+C⁢ξs.t.θ⋅(f⁢(x,y)-f⁢(x,y′))≥E⁢r⁢r⁢(y′)-E⁢r⁢r⁢(y)-ξ
...
because we do not rely on dynamic programming decoding. In our work we use feature templates up to 5-gram. Table
     ...
     <div class="ltx_section" id="S5">
      ...
      <div class="ltx_para" id="S5.p1">
       <p class="ltx_p">
        Datasets
        We evaluate our model on standard benchmark corpora — CoNLL 2006 and
CoNLL 2008
        [4, 30]
        — which include dependency treebanks for 14 different languages. Most of these data sets contain non-projective dependency trees. We use all sentences in CoNLL datasets during training and testing. We also use the Columbia Arabic Treebank (CATiB)
        [20]
