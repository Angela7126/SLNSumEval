   ...
   <div class="ltx_page_content">
    <div class="ltx_document ltx_authors_1line">
     <div class="ltx_abstract">
      ...
      <p class="ltx_p">
       In order to summarize a document, it is often useful
to have a
       background
       set of documents from the domain to serve as a reference for
...
in the input change one’s beliefs’ about the world represented in the background. We
...
in the update task where systems are given a small and topical background corpus.
      </p>
     </div>
