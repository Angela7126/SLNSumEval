  ...
  <root>
   ...
   <content>
    <section label="1">
     ...
     <paragraph>
      The remainder of this manuscript is organised as follows. We begin with a brief review of GPs in Section 2.1. We present our methods in Sections 2.2, 2.3, 2.4 and compare them against non-active strategies and GP based active learning methods in Section 2.5. In Section 3 we discuss alternatives for empirical evaluation and in Section 4 we present experimental results on synthetic and real problems.
     </paragraph>
    </section>
    <section label="2">
     <section-title>
     ...
     <section label="2.2">
      ...
      <paragraph>
       Finally, given any estimate {a mathematical formula}PˆAn(Xobs,θ) of the log joint probability constructed using a set {a mathematical formula}An of n parameter-likelihood pairs, the estimate of the posterior distribution is{a mathematical formula}
      </paragraph>
      <paragraph>
    ...
    <section label="3">
     ...
     <paragraph>
      5. Active Gaussian process regression (AGPR): &amp; 6. Bayesian optimisation (BO-EI): On our synthetic problems we also compare with the GP based active learning methods discussed in Section 2.5. For BO, we use the Expected Improvement [2]. We choose points using the above criterion and then regress on these points.
     </paragraph>
    </section>
    <section label="4">
     <section-title>
