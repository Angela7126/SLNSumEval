  ...
  <root>
   ...
   <content>
    ...
    <section label="2">
     ...
     <paragraph>
      Let X be the set of alternatives (items, products, candidates…) that need to be compared. Any alternative {a mathematical formula}x∈X is evaluated with respect to a set of n criteria denoted {a mathematical formula}N={1,…,n}, and is characterized by a performance vector {a mathematical formula}(x1,…,xn) where {a mathematical formula}xi∈[0,1] represents the utility of x with respect to criterion i for all {a mathematical formula}i∈N. We assume that the same utility scale is used for all components so that {a mathematical formula}xi and {a mathematical formula}xj can be compared when {a mathematical formula}i≠j. Let us now recall the definitions of Choquet capacities and discrete Choquet integrals. For simplicity, x will indifferently denote the alternative or its performance vector.
     </paragraph>
     <section label="2.1">
      <section-title>
       Discrete Choquet integrals
      </section-title>
      <paragraph>
       For any alternative {a mathematical formula}x∈X, let {a mathematical formula}(.) denote a permutation of {a mathematical formula}{1,…,n} that sorts the components of x by increasing order,{sup:1} i.e. {a mathematical formula}x(i)≤x(i+1) for {a mathematical formula}i∈〚1,n−1〛.
      </paragraph>
      <paragraph label="Definition 1">
       The ith level set of x, denoted by {a mathematical formula}X(i), is defined as {a mathematical formula}X(i)={(i),…,(n)}.
      </paragraph>
      <paragraph>
       Note that {a mathematical formula}X(i+1)⊆X(i) for all {a mathematical formula}i∈〚1,n−1〛 by definition.
      </paragraph>
      <paragraph label="Definition 2">
       A normalized Choquet capacity v is a real-valued set-function defined on {a mathematical formula}2N such that:
      </paragraph>
      <list>
       <list-item label="•">
        {a mathematical formula}v(∅)=0, {a mathematical formula}v(N)=1(normalization constraints)
       </list-item>
       <list-item label="•">
        {a mathematical formula}v(A)≤v(B) for all {a mathematical formula}A⊆B⊆N(monotonicity constraints)
       </list-item>
      </list>
      <paragraph label="Definition 3">
       The Choquet integral value of alternative {a mathematical formula}x∈X is defined as:{a mathematical formula}{a mathematical formula}Cv(x) represents the overall utility of alternative x. Therefore, alternative x is as least as good as y whenever {a mathematical formula}Cv(x)≥Cv(y).
      </paragraph>
      <paragraph label="Example 1">
       Consider a problem defined on 3 criteria, i.e. {a mathematical formula}N={1,2,3}, two alternatives {a mathematical formula}x=(0.7,0.6,1) and {a mathematical formula}y=(0.8,1,0.6) and the following capacity v defined on {a mathematical formula}2{1,2,3}:{a mathematical formula}Alternatives x and y induce the following level sets:
      </paragraph>
      <list>
       <list-item label="•">
        {a mathematical formula}X(1)={1,2,3}, {a mathematical formula}X(2)={1,3} and {a mathematical formula}X(3)={3};
       </list-item>
       <list-item label="•">
        {a mathematical formula}Y(1)={1,2,3}, {a mathematical formula}Y(2)={1,2} and {a mathematical formula}Y(3)={2}.
       </list-item>
      </list>
      <paragraph>
     ...
     <section label="2.2">
      <section-title>
       Choice based on the minimax regret criterion
      </section-title>
      <paragraph>
      ...
      <paragraph label="Definition 4">
       The pairwise max regret (PMR) of alternative x with respect to the alternative y is defined as:{a mathematical formula} In other words, the pairwise max regret of x with respect to y represents the worst-case loss when recommending x instead of y. We can establish a link with the notion of possible and necessary preferences used in other papers (see e.g. [18]): remark that {a mathematical formula}PMR(x,y,ΘP)&lt;0 means that x is necessarily better than y whereas {a mathematical formula}PMR(x,y,ΘP)&gt;0 means that y is possibly better than x. Finally {a mathematical formula}PMR(x,y,ΘP)=0 means that x is necessarily as least as good as y.
      </paragraph>
      <paragraph label="Definition 5">
       The max regret (MR) of alternative {a mathematical formula}x∈X is defined as:{a mathematical formula} The max regret of x is the worst-case loss when recommending x instead of one of the adversary's choices (i.e. any element of {a mathematical formula}arg⁡maxy∈X⁡PMR(x,y,ΘP)).
      </paragraph>
      <paragraph label="Definition 6">
       The minimax regret (mMR) is defined as:{a mathematical formula}
      </paragraph>
      <paragraph>
       An optimal solution for the minimax regret criterion is an alternative that achieves the minimax regret (i.e. any element of {a mathematical formula}arg⁡minx∈X⁡MR(x,X,ΘP)). Recommending such an alternative allows one to guarantee that the worst-case loss is minimized.
      </paragraph>
      <paragraph>
    ...
    <section label="3">
     ...
     <section label="3.1">
      ...
      <list>
       <list-item label="•">
        Case{a mathematical formula}A∈Aand{a mathematical formula}B∈A: we can directly infer the result since instantiation I is locally consistent.
       </list-item>
       <list-item label="•">
        Case{a mathematical formula}A∈Aand{a mathematical formula}B∉A: in that case, we have {a mathematical formula}A∈{B′∈A:B′⊂B}. Therefore:{a mathematical formula}
       </list-item>
       <list-item label="•">
       ...
       <list-item label="•">
        Case {a mathematical formula}A∉A and {a mathematical formula}B∉A: Since {a mathematical formula}A⊂B, we have {a mathematical formula}lA≤lB by hypothesis. Moreover, we necessarily have {a mathematical formula}{A′∈A:A′⊂A}⊂{B′∈A:B′⊂B}. Therefore, using Equation (10), we have:{a mathematical formula} □
       </list-item>
      </list>
      <paragraph>
       Since sets belonging to {a mathematical formula}A(x,y) are the only ones that appear in the objective function of PL1, then by applying Proposition 1 to set {a mathematical formula}A=A(x,y), we know that {a mathematical formula}PMR(x,y,ΘP) can be solved by considering only monotonicity constraints involving variables {a mathematical formula}vA, {a mathematical formula}A∈A(x,y). Therefore, we can compute {a mathematical formula}PMR(x,y,ΘP) by solving the following simpler linear program:{a mathematical formula}{a mathematical formula}{a mathematical formula}{a mathematical formula}{a mathematical formula}{a mathematical formula}
      </paragraph>
      <paragraph>
       This linear program includes at most {a mathematical formula}2n−1 variables (one per element of {a mathematical formula}A(x,y)) and only a quadratic number of monotonicity constraints.
      </paragraph>
     </section>
     <section label="3.2">
      <section-title>
     ...
     <section label="3.3">
      ...
      <paragraph label="Example 2 (continued)">
       ...
       <paragraph>
        Finally, the algorithm returns the following instantiation:{a mathematical formula}
       </paragraph>
      </paragraph>
     </section>
     <section label="3.4">
      <section-title>
       A query generation strategy for Choquet capacity elicitation
      </section-title>
      <paragraph>
    ...
    <section label="4">
     ...
     <section label="4.1">
      ...
      <paragraph>
       Note that one could consider other criteria, for example the average of the minimax regret values (allowing to compensate high regret values with lower ones); here we focus on the maximum, as it is a choice consistent with the pessimistic notion of max regret MR and it provides a performance guarantee with respect to the worst-case.
      </paragraph>
      <paragraph>
     ...
     <section label="4.2">
      <section-title>
       Determination of the optimal assignment
      </section-title>
      <paragraph>
