  ...
  <root>
   ...
   <content>
    ...
    <section label="2">
     ...
     <section label="2.1">
      <section-title>
       Type systems for state-space problems
      </section-title>
      <paragraph>
       For convenience, we define the type system as a partition of the nodes in the problem's UST.
      </paragraph>
      <paragraph label="Definition 1">
       Type systemLet {a mathematical formula}S(s⁎)=(N,E) be a UST rooted at {a mathematical formula}s⁎, where N is its set of nodes and for each {a mathematical formula}s∈N, {a mathematical formula}{s′|(s,s′)∈E} is s's set of child nodes. {a mathematical formula}T={t1,…,tk} is a type system for {a mathematical formula}S(s⁎) if it is a disjoint partitioning of N. If {a mathematical formula}s∈N and {a mathematical formula}t∈T with {a mathematical formula}s∈t, we write {a mathematical formula}T(s)=t.
      </paragraph>
      <paragraph label="Example 1">
       For the Sliding-Tile puzzle (described in A.2), for example, one could define a type system based on the position of the blank tile. In this case, two nodes s and {a mathematical formula}s′ would be of the same type if s has the blank in the same position as {a mathematical formula}s′, regardless of the configuration of the other tiles in the two nodes.
      </paragraph>
      <paragraph>
       We call a type system heuristic-based if all nodes of the same type have the same heuristic value. For a heuristic-based type system we define {a mathematical formula}h(t) to be the heuristic value of the states of type t. We assume in this work that the type system used is heuristic-based.
      </paragraph>
      <paragraph>
      ...
      <section label="2.1.1">
       <section-title>
        Type systems are not abstractions
       </section-title>
       <paragraph>
     ...
     <section label="2.2">
      <section-title>
       Predicting the size of the search tree
      </section-title>
      <paragraph>
     ...
     <section label="2.4">
      ...
      <paragraph label="Definition 2">
       Goal typeA type {a mathematical formula}tg∈T is a goal type if for all nodes {a mathematical formula}s∈tg, s is a goal node.
      </paragraph>
      <paragraph>
     ...
     <section label="2.5">
      <section-title>
       Stratified sampling for tree size prediction (SS)
      </section-title>
      <paragraph>
    ...
    <section label="3">
     <section-title>
      Bidirectional stratified sampling (BiSS)
     </section-title>
     <paragraph>
    ...
    <section label="4">
     ...
     <section label="4.1">
      <section-title>
       Heuristic functions as baselines
      </section-title>
      <paragraph>
     ...
     <section label="4.2">
      ...
      <paragraph>
       We use the following type systems in our experiments.{a mathematical formula} where {a mathematical formula}h(s) is the heuristic value of node s, {a mathematical formula}c(s,k) is how many of s's children have heuristic value k, and H is the maximum heuristic value a node can assume;{a mathematical formula} where {a mathematical formula}gc(s,k) is how many of s's grandchildren have heuristic value k.
      </paragraph>
      <paragraph>
       Two nodes have the same type according to {a mathematical formula}Tc if they have the same heuristic value and, for each k, they both have the same number of children with heuristic value k. {a mathematical formula}Tgc additionally requires the same heuristic distribution for the grandchildren.
      </paragraph>
     </section>
     <section label="4.3">
      <section-title>
     ...
     <section label="4.7">
      <section-title>
       Predictions for very large state spaces
      </section-title>
      <paragraph>
     ...
     <section label="4.8">
      ...
      <paragraph>
       We observed trends similar to the ones shown in Fig. 5, Fig. 6 in all other domains.
      </paragraph>
     </section>
    </section>
    <section label="5">
     <section-title>
      Learning strong heuristic functions from predictions
     </section-title>
     <paragraph>
     ...
     <section label="5.2">
      <section-title>
       Using BiSS to learn heuristic functions
      </section-title>
      <paragraph>
     ...
     <section label="5.3">
      <section-title>
       Experimental evaluation of BiSS-h
      </section-title>
      <section label="5.3.1">
       <section-title>
        Experimental setup
   ...
   <appendices>
    <section label="Appendix A">
     ...
     <section label="A.1">
      ...
      <paragraph>
       Depending on the number n of blocks this domain can have very large state spaces. For instance, when using {a mathematical formula}n=20 this domain has approximately 10{sup:20} different states.
      </paragraph>
      <paragraph>
      ...
      <section label="A.1.1">
       ...
       <paragraph>
        The features used for the NN were seven 2-block pattern databases, the number of out of place blocks, and the number of stacks of blocks. BiSS uses the {a mathematical formula}Tc type system with the Out of Place heuristic to predict the optimal solution cost of the instances in I. We discuss how the training instances in I were selected in Section 5.3.3. We used 50 random instances as the test set in the experiment presented in Section 5.3.
       </paragraph>
      </section>
     </section>
     <section label="A.2">
