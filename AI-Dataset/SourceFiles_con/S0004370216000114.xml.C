  ...
  <root>
   ...
   <content>
    <section label="1">
     ...
     <paragraph>
      SAT solving has marked a considerable practical success by enabling efficient solving of large industrial NP-hard problems. This motivates the study of computationally harder problems. Quantified Boolean formulas (QBFs) [1] naturally extend the SAT problem by enabling quantification. The cost of this extension is that deciding QBF formulas is PSPACE-complete. However, this also means that a larger set of problems can be targeted [2], [3], [4], [5].
     </paragraph>
     <paragraph>
      While nonrandom SAT solving has been dominated by the DPLL procedure, it has proven to be far from being a silver bullet for QBF solving. Indeed, a number of solving techniques have been proposed for QBF [6], [7], [8], [9], [10], complemented by a variety of preprocessing techniques[11], [12], [13], [14], [15], [16].
     </paragraph>
     <paragraph>
    ...
    <section label="2">
     ...
     <paragraph>
      Throughout the paper we operate on Boolean variables (x, {a mathematical formula}x1, etc.), which are composed into formulas by logical connectives with their standard semantics (∧, ∨, ¬, ⇒, ⇔). A Boolean formula in conjunctive normal form (CNF) is a conjunction of clauses, where a clause is a disjunction of literals, and a literal is either a variable or its complement. Whenever convenient, a CNF formula is treated as a set of clauses. For a literal l, {a mathematical formula}var(l) denotes the variable in l, i.e., {a mathematical formula}var(¬x)=var(x)=x. We write {a mathematical formula}|ϕ| to denote the size of a formula ϕ, defined as the sum of the number of connective and variable occurrences in ϕ.
     </paragraph>
     <paragraph>
      Variable assignments (τ, μ, etc.) are mappings from variables to the constants 0 and 1, represented as {a mathematical formula}x/1,y/0 etc. The constant 1 represents true and 0 represents false.
     </paragraph>
     <paragraph>
      Notation. We write {a mathematical formula}BY for the set of assignments to the variables Y.
     </paragraph>
     <paragraph>
      For a Boolean formula ϕ and an assignment τ we write {a mathematical formula}ϕ[τ] for the substitution of τ in ϕ. A substitution also performs basic simplifications, e.g. {a mathematical formula}(¬x∨y)[x/0]=(¬0∨y)=1. An assignment τ satisfies ϕ if {a mathematical formula}ϕ[τ]=1.
     </paragraph>
     <paragraph>
    ...
    <section label="3">
     ...
     <paragraph label="Example 4">
      The formula {a mathematical formula}∀u∃e.(u∨e)∧(u¯∨e¯) is true. Expanding e only by {a mathematical formula}{e/0} gives {a mathematical formula}∀u.u, which is false. Similarly, expanding e only by {a mathematical formula}{e/1} yields {a mathematical formula}∀u.u¯, which is also false. ▴
     </paragraph>
     <paragraph>
     ...
     <paragraph label="Observation 3">
      Let{a mathematical formula}ω,ω1,ω2,⊆BY.
     </paragraph>
     <list>
      <list-item label="1.">
       {a mathematical formula}M(∀X∃Y.ϕ)=M(∀X.⋁μ∈BYϕ[μ])
      </list-item>
      <list-item label="2.">
       {a mathematical formula}M(∃X∀Y.ϕ)=M(∃X.⋀μ∈BYϕ[μ])
      </list-item>
      <list-item label="3.">
       If{a mathematical formula}ω1⊆ω2then{a mathematical formula}M(∀X.⋁μ∈ω2ϕ[μ])⊆M(∀X.⋁μ∈ω1ϕ[μ])
      </list-item>
      <list-item label="4.">
       If{a mathematical formula}ω1⊆ω2then{a mathematical formula}M(∃X.⋀μ∈ω2ϕ[μ])⊆M(∃X.⋀μ∈ω1ϕ[μ])
      </list-item>
      <list-item label="5.">
       {a mathematical formula}M(∀X∃Y.ϕ)⊆M(∀X.⋁μ∈ωϕ[μ])
      </list-item>
      <list-item label="6.">
       {a mathematical formula}M(∃X∀Y.ϕ)⊆M(∃X.⋀μ∈ωϕ[μ])
      </list-item>
     ...
     <section label="3.1">
      ...
      <paragraph label="Proposition 2">
       Consider a run ofAlgorithm 1on a formula{a mathematical formula}Φ=QXQ¯Y.ϕ. Let{a mathematical formula}μiand{a mathematical formula}μkbe countermoves found in the i-th and k-th iterations of the loop, respectively, where{a mathematical formula}i&lt;k. Then{a mathematical formula}μi≠μk.
      </paragraph>
      <paragraph label="Proof">
      ...
      <paragraph>
       While the theoretical upper bound given by Proposition 3 is rather crude, we observe that Proposition 1 and Proposition 2 give us some further insights. A refinement by a countermove μ prevents the algorithm from finding any candidates to which μ is also a countermove.
      </paragraph>
      <paragraph>
    ...
    <section label="4">
     <section-title>
      Prenex QBF with arbitrary number of quantification levels
     </section-title>
     <paragraph>
     ...
     <paragraph label="Observation 4">
      Let Φ be QBF with free variables in{a mathematical formula}X∪Yand{a mathematical formula}ω1,ω2the subset of{a mathematical formula}BY.
     </paragraph>
     <list>
      <list-item label="1.">
       {a mathematical formula}M(∀X∃Y.Φ)=M(∀X.⋁μ∈BYΦ[μ])
      </list-item>
      <list-item label="2.">
       {a mathematical formula}M(∃X∀Y.Φ)=M(∃X.⋀μ∈BYΦ[μ])
      </list-item>
      <list-item label="3.">
       If{a mathematical formula}ω1⊆ω2then{a mathematical formula}M(∀X.⋁μ∈ω2Φ[μ])⊆M(∀X.⋁μ∈ω1Φ[μ])
      </list-item>
      <list-item label="4.">
       If{a mathematical formula}ω1⊆ω2then{a mathematical formula}M(∃X.⋀μ∈ω2Φ[μ])⊆M(∃X.⋀μ∈ω1Φ[μ])
      </list-item>
     ...
     <paragraph label="Definition 4">
      ω-abstractionLet ω be a subset of {a mathematical formula}BY.The ω-abstraction of a closed QBF {a mathematical formula}∀X∃Y.Φ is the formula {a mathematical formula}∀X.⋁μ∈ωΦ[μ].The ω-abstraction of a closed QBF {a mathematical formula}∃X∀Y.Φ is the formula {a mathematical formula}∃X.⋀μ∈ωΦ[μ].
     </paragraph>
     <paragraph>
     ...
     <paragraph>
      Algorithm 4 presents a pseudocode utilizing the above-introduced concepts. The algorithm is presented as a recursive function {a mathematical formula}Solve(QX.Φ) that accepts a QBF in prenex form with maximal quantifier blocks. The function returns a winning move for QX, if such exists, it returns NULL otherwise.
     </paragraph>
     <paragraph>
      If Φ does not contain any quantifiers (it is a propositional formula), a SAT solver is used to find a winning move (line 3). In the general case, utilizing this CEGAR paradigm, it initializes the set of countermoves ω to the empty set (line 4) and grows it by encountered countermoves (line 12).
     </paragraph>
     <paragraph>
     ...
     <section label="4.3">
      ...
      <paragraph>
       We have implemented a prototype{sup:4} of RAReQS in C++, supporting the QDIMACS format, with the underlying SAT solver minisat 2.2[31].
      </paragraph>
      <paragraph>
      ...
      <paragraph>
       If an assignment τ is a candidate for a winning move that turns out not to be a winning move, the refinement guarantees that τ is not a solution to the abstraction in the future iterations of the CEGAR loop. This knowledge enables us to make the subcall for solving the abstraction more efficient by explicitly disabling τ as a winning move for the abstraction. We refer to this technique as blocking and it is similar to the refinement used in certain SMT solvers [32], [33].
      </paragraph>
      <paragraph>
    ...
    <section label="5">
     ...
     <list>
      <list-item label="1.">
       form of the abstraction (function Abstract)
      </list-item>
      <list-item label="2.">
       test that a given move is a winning move (function Test)
      </list-item>
      <list-item label="3.">
       refinement
      </list-item>
     ...
     <paragraph label="Observation 6">
      The following equations hold.{a mathematical formula}
     </paragraph>
     <section label="5.1">
      <section-title>
       Abstraction
    ...
    <section label="6">
     ...
     <section label="6.1">
      <section-title>
       Ghost variables and sequent learning
      </section-title>
      <paragraph>
      ...
      <paragraph>
       For example, if {a mathematical formula}g1Q represents {a mathematical formula}x∧y, then {a mathematical formula}g1Q is assigned consistently under {a mathematical formula}{g1Q/0,x/0}, while it assigned inconsistently under {a mathematical formula}{g1Q/0,x/1,y/1}. Under {a mathematical formula}{g1Q/0}, {a mathematical formula}g1Q is not said to be either consistently or inconsistently assigned.
      </paragraph>
      <paragraph label="Definition 7">
       Winning under a total assignmentGiven a formula Φ, a quantifier type {a mathematical formula}Q∈{∃,∀}, and an assignment π to all the input variables and a subset of the ghost variables, we say “Player Qwins Φ under π” iff both of the following conditions hold true:
      </paragraph>
      <list>
       <list-item label="1.">
        {a mathematical formula}Φ[π]={true if Q is ∃false if Q is ∀
       </list-item>
       <list-item label="2.">
      ...
      <paragraph label="Definition 8">
       Losing under an assignmentGiven a formula Φ and an assignment π, we define the phrase “Player Qloses Φ under π” recursively. We say “Player Qloses Φ under π” iff either:
      </paragraph>
      <list>
       <list-item label="1.">
        Player Q does not win Φ under π and every input variable is assigned by π, or
       </list-item>
       <list-item label="2.">
        there is an outermost unassigned input variable x such that either:
       </list-item>
      </list>
      <paragraph>
       For example, consider a formula  {a mathematical formula}Φ=∀u∃e.u∧e. Then:
      </paragraph>
      <list>
       <list-item label="•">
        Player ∃ loses Φ under {a mathematical formula}{u/0,e/0}, by subpart 1 of Definition 8.
       </list-item>
       <list-item label="•">
        Player ∃ loses Φ under {a mathematical formula}{u/0}, by subpart 2(a) of Definition 8.
       </list-item>
       <list-item label="•">
        Player ∀ loses Φ under {a mathematical formula}{u/1}, by subpart 2(b) of Definition 8.
       </list-item>
      </list>
      <paragraph label="Definition 9">
       Game-state specifier, matchA game-state specifier is a pair {a mathematical formula}〈Lnow,Lfut〉 consisting of two sets of literals, {a mathematical formula}Lnow and {a mathematical formula}Lfut. We say that {a mathematical formula}〈Lnow,Lfut〉matches an assignment π iff:
      </paragraph>
      <list>
       <list-item label="1.">
        for every literal ℓ in {a mathematical formula}Lnow, {a mathematical formula}ℓ[π]=true, and
       </list-item>
       <list-item label="2.">
        for every literal ℓ in {a mathematical formula}Lfut, {a mathematical formula}ℓ[π]≠false (i.e., either {a mathematical formula}ℓ[π]=true or {a mathematical formula}var(ℓ)∉vars(π)).
       </list-item>
      </list>
      <paragraph>
       For example, {a mathematical formula}〈{u},{e}〉 matches the assignments {a mathematical formula}{u/1} and {a mathematical formula}{u/1,e/1} (because both conditions in Definition 9 are satisfied), but does not match the empty assignment (because condition 1 fails) or {a mathematical formula}{u/1,e/0} (because condition 2 fails).
      </paragraph>
      <paragraph>
       Note that, for any literal ℓ, if {a mathematical formula}{ℓ,¬ℓ}⊆Lfut, then {a mathematical formula}〈Lnow,Lfut〉 matches an assignment π only if π does not assign ℓ. The intuition behind the names “{a mathematical formula}Lnow” and “{a mathematical formula}Lfut” is as follows: Under the game formulation of QBF, the assignment π can be thought of as a state of the game, and π matches {a mathematical formula}〈Lnow,Lfut〉 iff every literal in {a mathematical formula}Lnow is already true in the game and, for every literal ℓ in {a mathematical formula}Lfut, it is possible that ℓ can be true in a future state of the game.
      </paragraph>
      <paragraph label="Definition 10">
       Game sequentThe sequent {a mathematical formula}〈Lnow,Lfut〉⊨(Q loses Φ) means “Player Q loses Φ under all assignments that match {a mathematical formula}〈Lnow,Lfut〉.”
      </paragraph>
      <paragraph>
       As an example, let Φ be the following formula:{a mathematical formula} Note that sequent {a mathematical formula}〈{u},{e}〉⊨(∀ loses Φ) holds true: in any assignment π that matches it, {a mathematical formula}Φ[π]=true. However, {a mathematical formula}〈{u},∅〉⊨(∀ loses Φ) does not hold true: it matches the assignment {a mathematical formula}{u/1,e/0}, under which Player ∀ does not lose Φ.
      </paragraph>
      <paragraph>
     ...
     <section label="6.3">
      ...
      <list>
       ...
       <list-item label="2.">
        Let guard be a subset of {a mathematical formula}πcur that assigns a subset of variables in {a mathematical formula}Z1,…,Zi−2. The choice of guard is heuristicly picked.
       </list-item>
       <list-item label="3.">
        Let {a mathematical formula}Zi+1′,…,Zn′ be fresh variables corresponding to {a mathematical formula}Zi+1,…,Zn, respectively.
       </list-item>
       <list-item label="4.">
        Let {a mathematical formula}ϕ′ be the result of substituting the assignment {a mathematical formula}πcex∪guard into ϕ and replacing all occurrences of variables in {a mathematical formula}Zi+1,….,Zn with {a mathematical formula}Zi+1′,…,Zn′, respectively.
       </list-item>
       <list-item label="5.">
        Introduce ghost variables for any formulas in {a mathematical formula}ϕ′ not already labeled by ghost variables. Add sequents that relate these ghost variables to the subformulas that they represent.
       </list-item>
       <list-item label="6.">
        Let {a mathematical formula}Q⁎ be {a mathematical formula}Q¯i. Let {a mathematical formula}g⁎Q⁎ be the ghost variable that labels the formula {a mathematical formula}ϕ′ (if {a mathematical formula}Q⁎ is ∀) or the negation of this ghost variable (if {a mathematical formula}Q⁎ is ∃).
       </list-item>
       <list-item label="7.">
        Learn the new sequent {a mathematical formula}〈guard∪{g⁎Q⁎},πcex〉⊨(Q⁎ loses Φ).
       </list-item>
      </list>
     </section>
    </section>
    <section label="7">
     ...
     <section label="7.1">
      <section-title>
       Experimental results for 2-level QCNF
      </section-title>
      <paragraph>
     ...
     <section label="7.3">
      <section-title>
       Experimental results for non-prenex non-CNF QBF
      </section-title>
      <paragraph>
    ...
    <section label="8">
     ...
     <paragraph>
      Since the publication of the 2-level QBF algorithm (AReQS), several similar approaches were used in specific domains [57], [58], [59], [60], [61], [62].
     </paragraph>
     <section label="8.1">
      <section-title>
      ...
      <section label="8.1.1">
       <section-title>
        Comparison to Quantor on a simple example
       </section-title>
       <paragraph>
      ...
      <section label="8.1.2">
       <section-title>
        Comparison to CSDCL solver on a simple example
       </section-title>
       <paragraph>
       ...
       <list>
        <list-item label="1.">
         RAReQS picks an assignment to X (line 7, with {a mathematical formula}ω=∅, so {a mathematical formula}α=1).
        </list-item>
        <list-item label="2.">
         RAReQS finds a counterexample for z, say {a mathematical formula}z=0.
        </list-item>
        <list-item label="3.">
         RAReQS tries to find another candidate for X. Substituting {a mathematical formula}z=0 into ϕ yields {a mathematical formula}hard(X)∧easy2(Y), which RAReQS gives to a SAT solver. The SAT solver is able to solve this by just solving the easy problem, and it quickly returns UNSAT.
        </list-item>
        <list-item label="4.">
         Since the SAT solver returned UNSAT, there is no possible winning move for X, so RAReQS returns NULL, indicating that the universal player wins.
        </list-item>
       </list>
      </section>
     </section>
