   ...
   <content>
    <section label="1">
     ...
     <list>
      ...
      <list-item label="•">
       We present an instantiation of LDC in {a mathematical formula}TE. The decision procedure can be proven to terminate within a finite number of steps.
      </list-item>
      <list-item label="•">
       We implement the instantiation of LDC in {a mathematical formula}TE as a prototype tool named PZ3 based on Z3. The experimental results show that PZ3 outperforms Z3 on various kinds of random or crafted problems, especially ones with sparse structures.
      </list-item>
     </list>
     <paragraph>
      The rest of the paper is organized as follows. Section 2 introduces formal preliminaries. In Section 3, we illustrate our framework by a motivating example. Section 4 presents LDC framework and Section 5 instantiates LDC in {a mathematical formula}TE. In Section 6, we prove some important properties of LDC and its instantiation in {a mathematical formula}TE. Section 7 demonstrates a detailed experimental evaluation of our parallelized solver PZ3. Finally, we survey some related work in Section 8 and conclude the paper in Section 9.
     </paragraph>
    </section>
    <section label="2">
     <section-title>
     ...
     <section label="2.2">
      ...
      <paragraph>
       Though the validity problem for {a mathematical formula}TE is undecidable due to the undecidability of first-order logic [17], its quantifier-free fragment is decidable in polynomial time using a procedure known as congruence closure [18]. Given a formula ϕ, this algorithm attempts to construct a congruence relation over subterms of ϕ, or to prove that such relation does not exist.
      </paragraph>
      <paragraph label="Example 1">
       Consider a formula:{a mathematical formula} Subterms of ϕ are {a mathematical formula}Sϕ={a,b,f(a),f(b)}. By the congruence closure algorithm, we can construct a relation R of subterms given by the partition {a mathematical formula}Sϕ/R={{a},{b},{f(a),f(b)}}. Therefore, ϕ is {a mathematical formula}TE-satisfiable.
      </paragraph>
     </section>
     <section label="2.3">
      <section-title>
    ...
    <section label="5">
     ...
     <section label="5.3">
      ...
      <paragraph label="Definition 1">
       {a mathematical formula}TE-interpretationGiven a congruence relation {a mathematical formula}{C1,…,Cn} where {a mathematical formula}C1,…,Cn are n congruence classes of terms, there is a {a mathematical formula}TE-interpretation {a mathematical formula}M=(D,(_)M) such that
      </paragraph>
      <list>
       <list-item label="1.">
        {a mathematical formula}D={μ1,…,μn} where {a mathematical formula}μ1,…,μn are labels for {a mathematical formula}C1,…,Cn respectively;
       </list-item>
       <list-item label="2.">
        {a mathematical formula}cM=μi if c is a constant symbol and {a mathematical formula}c∈Ci;
       </list-item>
       <list-item label="3.">
        {a mathematical formula}fM(μi1,…,μik)=μj if there exists a term {a mathematical formula}f(t1¯,…,tk¯)∈Cj and {a mathematical formula}t1¯∈Ci1,…,tk¯∈Cik.
       </list-item>
      </list>
      <paragraph label="Definition 2">
       It is possible to assign a different set of labels as the domain of a {a mathematical formula}TE-interpretation. Thus, a congruence relation can be represented by many isomorphic interpretations. The isomorphism over {a mathematical formula}TE-interpretations is defined below. Isomorphism of {a mathematical formula}TE-interpretationsLet {a mathematical formula}M1 and {a mathematical formula}M2 be {a mathematical formula}TE-interpretations, {a mathematical formula}D1 and {a mathematical formula}D2 be the domains of {a mathematical formula}M1 and {a mathematical formula}M2 respectively. A map {a mathematical formula}h:D1→D2 is an isomorphism of {a mathematical formula}M1 into {a mathematical formula}M2 if the following condition holds:
      </paragraph>
      <list>
       <list-item label="1.">
        h is bijective;
       ...
       <list-item label="2.">
        {a mathematical formula}h(cM1)=cM2 for each constant symbol {a mathematical formula}c∈Σ;
       </list-item>
       <list-item label="3.">
        {a mathematical formula}h(fM1(d1,…,dn))=fM2(h(d1),…,h(dn)), for each n-ary function symbol {a mathematical formula}f∈Σ and {a mathematical formula}d1,…,dn∈D1.
       </list-item>
      </list>
    ...
    <section label="6">
     ...
     <paragraph>
      In this section we analyze the LDC framework and its instantiation in {a mathematical formula}TE from a theoretical perspective. First we will show that LDC is sound and complete, i.e. it always returns correct results. Then, we will prove that the instantiation in {a mathematical formula}TE terminates after a finite number of steps. Finally, we discuss the generality of LDC.
     </paragraph>
     <section label="6.1">
      <section-title>
      ...
      <paragraph>
       Decompose is to make a k-decomposition of the formula ϕ, given ϕ and k:{a mathematical formula}
      </paragraph>
      <paragraph>
       Solve is to determine the satisfiability of input formula ϕ:{a mathematical formula}
      </paragraph>
      <paragraph>
       ComputeSharedInterp derives a shared interpretation {a mathematical formula}MS such that the domain of {a mathematical formula}(_)MS is {a mathematical formula}Σψ and {a mathematical formula}MS satisfies the constraint G:{a mathematical formula}
      </paragraph>
      <paragraph>
       Formulate is to convert the interpretation {a mathematical formula}MS into its semantically equivalent formula{a mathematical formula}FS. The concept of semantically equivalent formula is defined as follows.
      </paragraph>
      <paragraph label="Definition 4">
       Given an interpretation M and a formula ϕ, we say ϕ is fully interpreted by M iff each sub-term of ϕ can be interpreted as an element in the domain of M. We use the notation {a mathematical formula}LM to denote the set of all the formulae which can be fully interpreted by M.
      </paragraph>
      <paragraph label="Definition 5">
       Given an interpretation M, F is its semantically equivalent formula iff{a mathematical formula} We use the notation {a mathematical formula}M▷F to denote that the interpretation M and the formula F are semantically equivalent. Note that ▷ is non-commutative.
      </paragraph>
      <paragraph label="Proof">
       Given an interpretation M and its semantically equivalent formula F, for a formula{a mathematical formula}ϕ∈LMsuch that{a mathematical formula}ϕM=true, we have{a mathematical formula}F→ϕ.By Definition 5, {a mathematical formula}(¬ϕ)M=false⟺(¬ϕ∧F) is unsatisfiable. Thus {a mathematical formula}(¬F∨ϕ) is valid, and we have {a mathematical formula}F→ϕ. □
      </paragraph>
      <paragraph>
       Then, the formal specification of Formulate is as follows.{a mathematical formula}
      </paragraph>
      <paragraph>
       Furthermore, given an interpretation M, its semantically equivalent formula always exists. Consider two sets of formulae {a mathematical formula}FM={ϕ|ϕM=true} and {a mathematical formula}FM¯={ϕ|ϕM=false}, then we have {a mathematical formula}F=(⋀ϕ∈FMϕ)∧(⋀ρ∈FM¯¬ρ) such that {a mathematical formula}M▷F holds.
      </paragraph>
      <paragraph>
       Interpolate computes either an interpolant or an interpretation given two formulae.{a mathematical formula}
      </paragraph>
      <paragraph>
       CombineInterp is to check whether {a mathematical formula}M1,…,Mk are combinable with respect to the shared interpretation {a mathematical formula}MS where {a mathematical formula}MS▷FS and {a mathematical formula}Mi⊨(ψi∧FS) for each {a mathematical formula}1≤i≤k. It returns true if {a mathematical formula}M1,…,Mk are combinable, or false otherwise.{a mathematical formula}
      </paragraph>
      <paragraph>
       The interpretation combinability is formally defined as follows.
      </paragraph>
      <paragraph label="Definition 6">
       Interpretation combinabilityk interpretations {a mathematical formula}M1,…,Mk are combinable under the shared interpretation {a mathematical formula}MS if there exists {a mathematical formula}M1′≅M1,…,Mk′≅Mk where {a mathematical formula}M1′=(D1,(_)M1′),…,Mk′=(Dk,(_)Mk′) such that:
      </paragraph>
      <list>
       <list-item label="1.">
        {a mathematical formula}ΣMS=⋃1≤i&lt;j≤k(ΣMi∩ΣMj);
       </list-item>
       <list-item label="2.">
        {a mathematical formula}cMi′=cMj′=cMS for each constant {a mathematical formula}c∈ΣMi∩ΣMj ({a mathematical formula}1≤i&lt;j≤k);
       </list-item>
       <list-item label="3.">
      ...
      <list>
       <list-item label="1.">
        {a mathematical formula}ν1=ν2;
       </list-item>
       <list-item label="2.">
        there exists {a mathematical formula}c∈ΣM1∩ΣM2 such that {a mathematical formula}cM1=ν1 and {a mathematical formula}cM2=ν2;
       </list-item>
       <list-item label="3.">
        there exists {a mathematical formula}f∈ΣM1∩ΣM2 where f is an n-ary ({a mathematical formula}n&gt;0) function symbol, such that {a mathematical formula}fM1(ν11,…,ν1n)=ν1 and {a mathematical formula}fM2(ν21,…,ν2n)=ν2 where {a mathematical formula}ν1i∼ν2i ({a mathematical formula}1≤i≤n).
       </list-item>
      </list>
      <paragraph>
       Unify is to convert an interpretation M into a new one {a mathematical formula}M′ with respect to the shared interpretation {a mathematical formula}MS, such that:
      </paragraph>
      <list>
       <list-item label="1.">
        {a mathematical formula}M≅M′;
       </list-item>
       <list-item label="2.">
        Let h be the isomorphism of M into {a mathematical formula}M′, {a mathematical formula}D and {a mathematical formula}DS be the domains of M and {a mathematical formula}MS, respectively. For each {a mathematical formula}ν∈D and {a mathematical formula}νS∈DS, we have {a mathematical formula}h(ν)=νS⟺ν∼νS.
       </list-item>
      </list>
      ...
      <paragraph>
       Given {a mathematical formula}M1,…,Mk and the shared interpretation {a mathematical formula}MS, ExtractSFA returns a set F of shared function applications. All the function applications {a mathematical formula}(f,d) that meet the following requirements are in F.
      </paragraph>
      <list>
       <list-item label="1.">
        f is an n-ary ({a mathematical formula}n&gt;0) function symbol, {a mathematical formula}f∈ΣMS and {a mathematical formula}d∈DSn;
       </list-item>
       <list-item label="2.">
        there exists {a mathematical formula}1≤i&lt;j≤k such that:
       </list-item>
      </list>
      ...
      <paragraph label="Lemma 9">
       CombineInterpin{a mathematical formula}TEis sound.
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Lemma 10">
       LDC in{a mathematical formula}TEis sound and complete, on the premise that it terminates.
      </paragraph>
     </section>
     <section label="6.2">
      <section-title>
      ...
      <paragraph label="Theorem 16">
       LDC in{a mathematical formula}TEterminates within finite steps.
      </paragraph>
      <paragraph label="Theorem 17">
       LDC in{a mathematical formula}TEis sound and complete.
      </paragraph>
     </section>
     <section label="6.3">
      <section-title>
    ...
    <section label="7">
     ...
     <section label="7.2">
      ...
      <list>
       <list-item label="1.">
        Can PZ3 outperform its baseline Z3?
       </list-item>
       <list-item label="2.">
        How does the parallel efficiency vary with (a) the number of cores, (b) the problem structure?
       </list-item>
       <list-item label="3.">
        Where does the speed-up of PZ3 come from?
       </list-item>
       <list-item label="4.">
        How are PZ3's time costs distributed to working phases and operations?
       </list-item>
       <list-item label="5.">
        How effective is LDC compared to other parallelization approaches?
       </list-item>
      </list>
      <paragraph>
      ...
      <paragraph>
       All the experiments except the second one are based on the QF_UF benchmarks of SMT-LIB.{sup:3} The benchmark problems are originated from three application domains:
      </paragraph>
      <list>
       <list-item label="1.">
        minimum transitivity constraints (MTC): 100 hierarchical problems containing contradictory cycles [34];
       </list-item>
       <list-item label="2.">
        automatic theorem proving (ATP): problems obtained by trying to find a finite model of first-order formulae. There are 3 subcategories: SEQ, PEQ and NEQ with respective 56, 47, 48 problems.
       </list-item>
       <list-item label="3.">
        quasigroup (QG): problems in loop theory and quasigroup theory [35]. There are 4 subcategories: loops6, QG5, QG6 and QG7 with respective 448, 5286, 244, 418 problems.
       </list-item>
      </list>
      <paragraph>
     ...
     <section label="7.3">
      ...
      <paragraph>
       MTC:PZ3 shows significant superiority in this category using k ({a mathematical formula}k≥4) cores. Z3 can only solve 21 problems while PZ3 can solve all 100 problems when {a mathematical formula}k≥6. In particular, when {a mathematical formula}k=9, PZ3 uses only 5.13 s on each problem averagely. When {a mathematical formula}k=2,3, PZ3 fails to outperform Z3 because subformulae are still difficult to be solved. Fig. 5 also shows that for the problems solved by Z3 within 1 s, PZ3 generally takes more time. This is because they have low problem complexities and thus PZ3 can hardly benefit from decomposition on them.
      </paragraph>
      <paragraph>
       ATP: In general, PZ3 is disadvantageous in this category as Z3 outperforms PZ3 on both the solving time and the number of solved problems. However, Fig. 5 shows that PZ3 has better performance than Z3 on a large portion of problems which are difficult for Z3 (more specifically, with more than 10{sup:4}s of time cost).
      </paragraph>
      <paragraph>
       QG:Table 5 shows that both PZ3 and Z3 are capable to solve all the problems in this category. On the one hand, PZ3 is disadvantageous in the loops6 subcategory because the majority of its problems (332 out of 448) can be solved by Z3 within 300 ms while PZ3 has inherent overhead on decomposition and thread manipulation. On the other hand, PZ3 is generally more efficient in the QG5-QG7 subcategories. Furthermore, Fig. 5 also shows that PZ3 has an advantage on the problems difficult for Z3 (requiring more than 10{sup:4}s).
      </paragraph>
      <paragraph>
       Table 6 lists the ratio of problems on which PZ3 has improved performance, with respect to the number of cores. Problems solved within 300 ms by both PZ3 and Z3 are not included because their differences can be substantially influenced by random errors in timing. The results show that PZ3 succeeds in achieving speed-up on more than one half of problems when the number of cores in use is 2, 4 or 5. Under other core configurations, the ratio ranges from 0.376 to 0.459.
      </paragraph>
      <paragraph>
     ...
     <section label="7.4">
      <section-title>
       Speed-up and formula sparseness
      </section-title>
      <paragraph>
     ...
     <section label="7.7">
      <section-title>
       Comparison with the portfolio approach
      </section-title>
      <paragraph>
