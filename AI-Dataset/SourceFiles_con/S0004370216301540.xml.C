  ...
  <root>
   ...
   <content>
    <section label="1">
     ...
     <list>
      <list-item label="1.">
       We generalize the MMMF-based active transfer learning method proposed in [12] to a unified framework.
      </list-item>
      <list-item label="2.">
       Based on the framework, we further specify two more solutions based on other well-known CF methods, namely RLMF and PMF.
      </list-item>
      <list-item label="3.">
       We conduct extensive experiments to verify the effectiveness of the proposed active transfer learning framework for cross-system CF.
      </list-item>
     </list>
     <paragraph>
    ...
    <section label="2">
     ...
     <paragraph>
      Recommender systems emerged as an independent research area in the mid-1990s [13], [14], and attracted more and more attention from both academia and industry since the Netflix competition{sup:2} held between 2006 and 2009. Besides products/services recommendation for e-commerce, recommender systems have been employed in many other application areas, such as configuration for products design [15], requirement engineering [16], music recommendation [17], tag recommendation in the social web [18], etc. Among various techniques for recommender systems, AI-based methods, specially CF methods through matrix factorization, have proven to be effective and promising [19], [11].
     </paragraph>
     <paragraph>
    ...
    <section label="4">
     <section-title>
      Active transfer learning for cross-system collaborative filtering
     </section-title>
     <section label="4.1">
      <section-title>
       A unified framework
      ...
      <section label="4.1.2">
       High-level idea on {a mathematical formula}ActiveLearn()
       <paragraph>
       ...
       <list>
        <list-item label="•">
         We first denote by {a mathematical formula}δ(d)(u,v) an certainty measure of the prediction of a matrix-factorization-based CF model on a user-item pair {a mathematical formula}(u,v) in the target system. The larger is the value, the more certain or confident is the prediction.
        </list-item>
        <list-item label="•">
     ...
     <section label="4.2">
      <section-title>
       A solution equipped with Maximum-Margin Matrix Factorization
      </section-title>
      <paragraph>
     ...
     <section label="4.4">
      ...
      <section label="4.4.1">
       <section-title>
        PMF with partial entity correspondence
       </section-title>
       <paragraph>
        By plugging the objective of PMF (11) and the regularization term of cross-system entity correspondences (14) into the framework (12), we obtain the optimization problem of the extended PMF method in the transfer learning manner with partial entity correspondences between systems as follows,{a mathematical formula} where{a mathematical formula} In the sequel, we denote by {a mathematical formula}PMFTL the optimization problem (26). For comparison on the impact of different regularization terms to transfer learning, we denote by {a mathematical formula}PMFCMF the optimization problem by replacing the last regularization term in (26) by the CMF regularization term (13) as follows,{a mathematical formula}
       </paragraph>
      </section>
      <section label="4.4.2">
       <section-title>
        Actively constructing entity correspondences through PMF
       </section-title>
       <paragraph>
    ...
    <section label="5">
     ...
     <section label="5.3">
      <section-title>
       Experiments on different active learning strategies
      </section-title>
      <paragraph>
       In the second experiment, we aim to verify the performance of our proposed active transfer learning framework plugging with different entity selection strategies. Here, we use {a mathematical formula}MTL as the base transfer learning approach to cross-domain CF. Regarding entity selection strategies, besides the proposed approaches, {a mathematical formula}MGhy with {a mathematical formula}MMMFTL, {a mathematical formula}EEhy with {a mathematical formula}RLMFTL, and {a mathematical formula}EShy with {a mathematical formula}PMFTL, we also conduct comparison experiments on the following strategies:
      </paragraph>
      <list>
       <list-item label="•">
