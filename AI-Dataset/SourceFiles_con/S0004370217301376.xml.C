  ...
  <root>
   ...
   <content>
    ...
    <section label="2">
     ...
     <paragraph>
      Throughout the contribution, given are a countable set of propositional variables P and a (disjoint) finite set of agents N.
     </paragraph>
     <section label="2.1">
      <section-title>
       Structures
      ...
      <paragraph>
       An epistemic awareness model is a multi-agent Kripke model enriched with a propositional awareness function, that determines the set of propositional variables of which an agent is aware in a given state.
      </paragraph>
      <paragraph label="Definition 3">
       Epistemic awareness modelAn epistemic awareness model is a tuple {a mathematical formula}M=(S,R,A,V) where
      </paragraph>
      <list>
       <list-item label="•">
        S (also denoted by {a mathematical formula}D(M)) is a non-empty set of states;
       </list-item>
       <list-item label="•">
        {a mathematical formula}R:N→P(S×S) is an accessibility function;
       </list-item>
       <list-item label="•">
        {a mathematical formula}A:N→S→P(P) is an awareness function;
       </list-item>
       <list-item label="•">
        {a mathematical formula}V:P→P(S) is a valuation.
       </list-item>
      </list>
      <paragraph>
       We write {a mathematical formula}Ri for {a mathematical formula}R(i), {a mathematical formula}Ai for {a mathematical formula}A(i), and {a mathematical formula}Ri(s) or {a mathematical formula}sRi for {a mathematical formula}{t∈S|Ri(s,t)}. A pair {a mathematical formula}(M,s) is also called a pointed (epistemic awareness) model. Several classes of epistemic awareness models will be of our interest.
      </paragraph>
      <paragraph label="Definition 4">
       Frame and awareness propertiesAn epistemic awareness model {a mathematical formula}M=(S,R,A,V) is image-finite if all {a mathematical formula}Ri(s) are finite. Model M satisfies the property of awareness introspection if {a mathematical formula}t∈Ri(s) implies {a mathematical formula}Ai(s)=Ai(t), for all states and agents. The class of all models is {a mathematical formula}K, the class of models for which all {a mathematical formula}Ri are equivalence relations is called {a mathematical formula}S5, and the class for which all {a mathematical formula}Ri are serial, transitive and euclidean is {a mathematical formula}KD45. Finally, the class of models with equivalence relations and satisfying awareness introspection is {a mathematical formula}S5AI.
      </paragraph>
      <paragraph>
       We associate two notions of bisimulation [34], [3] with epistemic awareness models. Standard bisimulation is the more obvious one, but awareness bisimulation is evidently the more suitable notion in view of our introductory examples. The motivation for awareness bisimulation was the lattice of state spaces in [19]; see also [36], [37].
      </paragraph>
      <paragraph label="Definition 5">
       Standard bisimulationLet {a mathematical formula}Q⊆P. A Q standard bisimulation between epistemic awareness models {a mathematical formula}M=(S,R,A,V) and {a mathematical formula}M′=(S′,R′,A′,V′) is a relation {a mathematical formula}R[Q]⊆(S×S′) such that, for every {a mathematical formula}(s,s′)∈R[Q], for every agent {a mathematical formula}i∈N, and for every {a mathematical formula}p∈Q:
      </paragraph>
      <list>
       <list-item label="•">
        atoms:{a mathematical formula}s∈V(p) iff {a mathematical formula}s′∈V′(p);
       </list-item>
       <list-item label="•">
        aware:{a mathematical formula}Q∩Ai(s)=Q∩Ai′(s′);
       </list-item>
       <list-item label="•">
        forth: if {a mathematical formula}t∈Ri(s) then there is a {a mathematical formula}t′∈Ri′(s′) such that {a mathematical formula}(t,t′)∈R[Q];
       </list-item>
       <list-item label="•">
        back: if {a mathematical formula}t′∈Ri′(s′) then there is a {a mathematical formula}t∈Ri(s) such that {a mathematical formula}(t,t′)∈R[Q].
       </list-item>
      </list>
      <paragraph>
       The definition of awareness bisimulation is almost the same as that of standard bisimulation. Only the clauses for forth and back are different.
      </paragraph>
      <paragraph label="Definition 6">
       Awareness bisimulationLet {a mathematical formula}Q⊆P. A Q awareness bisimulation between {a mathematical formula}M=(S,R,A,V) and {a mathematical formula}M′=(S′,R′,A′,V′) is a function {a mathematical formula}R that maps each subset {a mathematical formula}Q′⊆Q to a binary relation {a mathematical formula}R[Q′]⊆(S×S′) such that, for every {a mathematical formula}(s,s′)∈R[Q′], for every agent {a mathematical formula}i∈N, and for every {a mathematical formula}p∈Q′:
      </paragraph>
      <list>
       <list-item label="•">
        atoms:{a mathematical formula}s∈V(p) iff {a mathematical formula}s′∈V′(p);
    ...
    <section label="4">
     ...
     <section label="4.2">
      ...
      <paragraph label="Theorem 26">
       [40]On image-finite models:{a mathematical formula}(M,s)↔_Q(M′,s′)iff{a mathematical formula}(M,s)≡QE(M′,s′).
      </paragraph>
     ...
     <section label="4.4">
      ...
      <list>
       <list-item label="•">
        {a mathematical formula}(M,s) and {a mathematical formula}(M′,s′)have the same implicit knowledge iff for all i and for all {a mathematical formula}φ∈L□, {a mathematical formula}(M,s)⊨□iφ iff {a mathematical formula}(M′,s′)⊨□iφ.
       </list-item>
       <list-item label="•">
        {a mathematical formula}(M,s) and {a mathematical formula}(M′,s′)have the same explicit knowledge iff for all i and for all {a mathematical formula}φ∈LE, {a mathematical formula}(M,s)⊨KEiφ iff {a mathematical formula}(M′,s′)⊨KiEφ.
       </list-item>
       <list-item label="•">
        {a mathematical formula}(M,s) and {a mathematical formula}(M′,s′)have the same speculative knowledge iff for all i and for all {a mathematical formula}φ∈LS, {a mathematical formula}(M,s)⊨KiSφ iff {a mathematical formula}(M′,s′)⊨KiSφ.
       </list-item>
      </list>
      <paragraph>
       We could also have similarly defined ‘having the same ignorance’, but this is already entailed by having the same knowledge. If two epistemic awareness states have the same implicit or speculative knowledge, it is clear that they then also have the same implicit or speculative ignorance, as these are dual modalities. For explicit ignorance this also holds (see Section 2.2 for the definition by abbreviation of {a mathematical formula}LiE), in view of some simple equivalences.{a mathematical formula} The notion of implicit knowledge we consider of lesser interest in this section, as it is more an auxiliary notion and does not correspond to an agent perspective. If {a mathematical formula}(M,s) and {a mathematical formula}(M′,s′) are P awareness bisimilar for the set P of all propositional variables, then they are modally equivalent in {a mathematical formula}LE (Proposition 24), and therefore they clearly have the same explicit knowledge. The following Proposition 33 says that it is sufficient that they are Q awareness bisimilar for {a mathematical formula}Q=Ai(s), in other words, up to what agent i can see. Proposition 34 after that, says the same thing but for speculative knowledge. On the heels of those two propositions is the obvious version for all agents, Proposition 35.
      </paragraph>
      <paragraph label="Proposition 33">
       If{a mathematical formula}(M,s)↔_Ai(s)(M′,s′), then{a mathematical formula}(M,s)and{a mathematical formula}(M′,s′)have the same explicit knowledge for agent i.
      </paragraph>
      <paragraph label="Proof">
      ...
      <paragraph label="Proposition 34">
       If{a mathematical formula}(M,s)↔_Ai(s)(M′,s′), then{a mathematical formula}(M,s)and{a mathematical formula}(M′,s′)have the same speculative knowledge for agent i.
      </paragraph>
      <paragraph label="Proof">
    ...
    <section label="5">
     ...
     <section label="5.1">
      ...
      <list>
       <list-item label="1.">
        {a mathematical formula}φ→φQ is valid, and
       </list-item>
       <list-item label="2.">
        the validity of {a mathematical formula}φ→γ implies the validity of {a mathematical formula}φQ→γ for all formulas γ not containing any atoms from {a mathematical formula}Q′.
       </list-item>
      </list>
      <paragraph>
     ...
     <section label="5.2">
      ...
      <paragraph label="Proposition 45">
       {a mathematical formula}L()is less expressive than all of{a mathematical formula}L(A),{a mathematical formula}L(KE),{a mathematical formula}L(□), and{a mathematical formula}L(KS).
      </paragraph>
      <paragraph label="Proof">
       Trivial. □
      </paragraph>
      <paragraph label="Proposition 46">
       {a mathematical formula}L(□)is less expressive than{a mathematical formula}L(□,A).
      </paragraph>
      <paragraph label="Proof">
      ...
      <paragraph>
       In the proof of this proposition we only considered a single propositional variable and a single agent (that is therefore unlabeled in the figure), but for modal equivalence we of course need to consider all of the countably infinite set of variables and all agents. It will be clear that our examples can be adjusted to accommodate an entire valuation (instead of making single atom p true in one state and false in another, make all variables true in one state and make all false in another) or accessibility relations for all agents (not in {a mathematical formula}N1 but in the other models in Fig. 7, instead of a pair in the accessibility relation for a single agent, take n identical such pairs namely for all of the n agents). Therefore, the restrictions in our proofs are without loss of generality.
      </paragraph>
      <paragraph>
       It is surprising that awareness is definable from explicit knowledge, but that awareness is not definable from speculative knowledge, as this proposition demonstrates. Still, the logic of speculative knowledge (with language {a mathematical formula}L(KS,A)) and the logic of explicit knowledge (with language {a mathematical formula}L(KE,A)) are equally expressive. As we also have {a mathematical formula}L(KE,A)∼L(KE), the surprise comes from the contrast between {a mathematical formula}L(KS,A)∼L(KE,A) and {a mathematical formula}L(KS)≺L(KE). In the presence of awareness, speculative and explicit knowledge are the same, otherwise, they are not.
      </paragraph>
      <paragraph label="Proposition 49">
       {a mathematical formula}L(□)is incomparable to{a mathematical formula}L(KE).
      </paragraph>
      <paragraph label="Proof">
      ...
      <paragraph label="Proposition 50">
       The languages{a mathematical formula}L(□),{a mathematical formula}L(A), and{a mathematical formula}L(KS)are pairwise incomparable.
      </paragraph>
      <paragraph label="Proof">
     ...
     <section label="5.3">
      ...
      <paragraph label="Proof">
       {a mathematical formula}L(A)≺S5AIL(KE).The epistemic awareness states {a mathematical formula}(M4,w) and {a mathematical formula}(M4′,w′) in Fig. 9 are modally equivalent in {a mathematical formula}L(A)|{p}, yet distinguishable by {a mathematical formula}KEp in {a mathematical formula}L(KE)|{p}. □
      </paragraph>
      <paragraph label="Proof">
     ...
     <section label="6.1">
      ...
      <section label="6.1.3">
       ...
       <paragraph label="Theorem 66">
        SoundnessEvery theorem of{a mathematical formula}LSis valid.
       </paragraph>
       <paragraph label="Proof">
        This is a quite standard proof, and we only need to examine the axioms and rules involving speculative knowledge. Showing the validity of axiom KS and validity preservation of the rule of necessitation NS is straightforward, and these are also found in [37]. We now get to the validity of the axioms SK and SKA.We start with SK. We will give a formal proof via the contrapositive. Let {a mathematical formula}(M,s) be some model such that {a mathematical formula}(M,s)⊨LiSφ[ψ\p]∧¬Aip. Let {a mathematical formula}N=(SM,RM,A⁎,V⁎) where
        <list>
         for all {a mathematical formula}t∈SM, for all agents j, {a mathematical formula}Aj⁎(t)\{p}=AjM(t)\{p}, and {a mathematical formula}p∈Ai⁎(t) if and only if {a mathematical formula}(M,t)⊨Aiψ;for all atoms {a mathematical formula}q≠p, {a mathematical formula}V⁎(q)=VM(q), and {a mathematical formula}V⁎(p)={t|(M,t)⊨ψ}.For axiom SKA we use a similar argument with the construction of
        </list>
        <paragraph>
         N adjusted such that:
        </paragraph>
        <list>
         <list-item label="•">
          for all {a mathematical formula}t∈SM, for all agents {a mathematical formula}k≠j (where k may be i), {a mathematical formula}Ak⁎(t)=AkM(t), {a mathematical formula}Aj⁎(t)=AjM(t)∪{p} if {a mathematical formula}(M,t)⊨ψ, and {a mathematical formula}Aj⁎(t)=AjM(t)\{p}, otherwise;
         </list-item>
         <list-item label="•">
          for all atoms q, {a mathematical formula}V⁎(q)=VM(q).
         </list-item>
        </list>
        <paragraph>
         Again we have {a mathematical formula}(M,t)↔_Ai(s)(N,t), and the proof proceeds as before. Note that in this case agent j's awareness of p coincides with the truth of ψ, so the argument only holds as long as ψ is not interpreted in the scope of an awareness operator. □
        </paragraph>
       </paragraph>
       <paragraph>
       ...
       <paragraph label="Definition 67">
        Canonical modelThe canonical model for {a mathematical formula}LS is a tuple {a mathematical formula}Mc=(Sc,Rc,Ac,Vc) where
       </paragraph>
       <list>
        <list-item label="•">
         {a mathematical formula}Sc is the set of all theories (maximal consistent sets) of {a mathematical formula}LS;
        </list-item>
        <list-item label="•">
         For any {a mathematical formula}i∈N, {a mathematical formula}Ric is a binary relation on {a mathematical formula}Sc such that {a mathematical formula}Ric(Φ,Ψ) iff for all φ, {a mathematical formula}KiSφ∈Φ implies {a mathematical formula}φ∈Ψ;
        </list-item>
        <list-item label="•">
         {a mathematical formula}Ac:N→Sc→2P is such that {a mathematical formula}p∈Aic(Φ) iff {a mathematical formula}Aip∈Φ;
        </list-item>
        <list-item label="•">
         {a mathematical formula}Vc:P→Sc is such that {a mathematical formula}Φ∈Vc(p) iff {a mathematical formula}p∈Φ.
        </list-item>
     ...
     <section label="6.2">
      ...
      <section label="6.2.3">
       ...
       <list>
        ...
        <list-item label="•">
         For any {a mathematical formula}i∈N, {a mathematical formula}Ric is a binary relation on {a mathematical formula}Sc such that {a mathematical formula}Ric(Φ,Ψ) iff
        </list-item>
        <list-item label="•">
         {a mathematical formula}Ac:N→Sc→2P is such that {a mathematical formula}p∈Aic(Φ) iff {a mathematical formula}Aip∈Φ;
        </list-item>
       ...
       <paragraph>
        The additional clause in the second item ensures that the resulting canonical model satisfies awareness introspection.
       </paragraph>
       <paragraph label="Theorem 76">
        CompletenessLet{a mathematical formula}Φ⊆LSbe a maximal consistent subset. Then{a mathematical formula}MΦc⊨φif and only if{a mathematical formula}φ∈Φ.
       </paragraph>
       <paragraph>
        This theorem can be shown in the same way as Lemma 70 above, noting that the canonical model (Definition 75) is an {a mathematical formula}S5AI model.
       </paragraph>
      </section>
     </section>
    </section>
