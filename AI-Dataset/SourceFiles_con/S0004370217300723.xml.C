   ...
   <content>
    ...
    <section label="2">
     ...
     <section label="2.3">
      ...
      <paragraph>
       We present briefly the KPP framework for merging operators of belief bases [17], [19].
      </paragraph>
      <paragraph>
       A profile Ψ is a nonempty multi-set (bag) of belief bases {a mathematical formula}Ψ={φ1,…,φn} (hence different agents are allowed to exhibit identical bases), and represents a group of n agents. We denote by {a mathematical formula}G the set of profiles.
      </paragraph>
      <paragraph>
       We denote by {a mathematical formula}{an inline-figure}Ψ the conjunction of bases of {a mathematical formula}Ψ={φ1,…,φn}, i.e., {a mathematical formula}{an inline-figure}Ψ=φ1∧…∧φn. As usual, we write {a mathematical formula}w⊨Ψ instead of {a mathematical formula}w⊨{an inline-figure}Ψ.
      </paragraph>
      <paragraph>
       A profile Ψ is said to be consistent if and only if {a mathematical formula}{an inline-figure}Ψ is consistent. The multi-set union is noted ⊔. By abuse of notation we will write φ instead of {a mathematical formula}{φ} (a profile with a unique belief base); thus, we will write {a mathematical formula}φ⊔Ψ instead of {a mathematical formula}{φ}⊔Ψ. Two profiles are equivalent, denoted {a mathematical formula}Ψ1≡Ψ2, if there is a bijective function f from {a mathematical formula}Ψ1 onto {a mathematical formula}Ψ2 such that for any {a mathematical formula}φ∈Ψ1, {a mathematical formula}f(φ)≡φ.
      </paragraph>
      <paragraph>
       All merging operators considered in this framework are functions from the set of profiles and the set of propositional formulae (that will represent integrity constraints) to the set of belief bases, i.e. {a mathematical formula}Δ:G×LP↦LP. We will use the notation {a mathematical formula}Δμ(Ψ) instead of {a mathematical formula}Δ(Ψ,μ).
      </paragraph>
      <paragraph>
       An IC merging operator is a merging operator satisfying the following postulates:
      </paragraph>
      <list>
       <list-item>
        {a mathematical formula}Δμ(Ψ)⊢μ
       </list-item>
       <list-item>
        If{a mathematical formula}μ⊬⊥, then{a mathematical formula}Δμ(Ψ)⊬⊥
       </list-item>
       <list-item>
        If{a mathematical formula}{an inline-figure}Ψ∧μ⊬⊥, then{a mathematical formula}Δμ(Ψ)≡{an inline-figure}Ψ∧μ
       </list-item>
       <list-item>
        If{a mathematical formula}Ψ≡Φand{a mathematical formula}μ≡ν, then{a mathematical formula}Δμ(Ψ)≡Δν(Φ)
       </list-item>
       <list-item>
        If{a mathematical formula}θ⊢μ,{a mathematical formula}φ⊢μand{a mathematical formula}Δμ(θ⊔φ)∧θ⊬⊥, then{a mathematical formula}Δμ(θ⊔φ)∧φ⊬⊥
       </list-item>
       <list-item>
        {a mathematical formula}Δμ(Ψ)∧Δμ(Φ)⊢Δμ(Ψ⊔Φ)
       </list-item>
       <list-item>
        If{a mathematical formula}Δμ(Ψ)∧Δμ(Φ)⊬⊥then{a mathematical formula}Δμ(Ψ⊔Φ)⊢Δμ(Ψ)∧Δμ(Φ)
       </list-item>
       <list-item>
        {a mathematical formula}Δμ(Ψ)∧ν⊢Δμ∧ν(Ψ)
       </list-item>
       <list-item>
        If{a mathematical formula}Δμ(Ψ)∧ν⊬⊥then{a mathematical formula}Δμ∧ν(Ψ)⊢Δμ(Ψ)∧ν
       </list-item>
      </list>
      <paragraph>
       A merging operator is called an IC quasi-merging operator[17] if it satisfies (IC1)–(IC5), (IC7), (IC8), and the following postulate (IC6′) (which is a weakening of (IC6)):
      </paragraph>
      <list>
       <list-item>
        If{a mathematical formula}Δμ(Ψ)∧Δμ(Φ)⊬⊥then{a mathematical formula}Δμ(Ψ⊔Φ)⊢Δμ(Ψ)∨Δμ(Φ)
      ...
      <paragraph>
       Explanations about the rationality of these postulates can be found in [17], [19]. However, given the similarity with ES fusion postulates of Section 3, interpretations about the meaning of these postulates can be also found in that section.
      </paragraph>
      <paragraph>
       A syncretic assignment is a function mapping each profile Ψ to a total pre-order {a mathematical formula}≤Ψ over interpretations such that for any profiles {a mathematical formula}Ψ,Ψ1,Ψ2 and for any belief bases {a mathematical formula}φ,φ′, the following conditions hold:
      </paragraph>
      <list>
       <list-item label="1.">
        If {a mathematical formula}w⊨Ψ and {a mathematical formula}w′⊨Ψ, then {a mathematical formula}w≃Ψw′
       </list-item>
       <list-item label="2.">
        If {a mathematical formula}w⊨Ψ and {a mathematical formula}w′⊭Ψ, then {a mathematical formula}w&lt;Ψw′
       </list-item>
       <list-item label="3.">
        If {a mathematical formula}Ψ1≡Ψ2, then {a mathematical formula}≤Ψ1=≤Ψ2
       </list-item>
       <list-item label="4.">
        For any {a mathematical formula}w⊨φ there exists {a mathematical formula}w′⊨φ′ such that {a mathematical formula}w′≤φ⊔φ′w
       </list-item>
       <list-item label="5.">
        If {a mathematical formula}w≤Ψ1w′ and {a mathematical formula}w≤Ψ2w′, then {a mathematical formula}w≤Ψ1⊔Ψ2w′
       </list-item>
       <list-item label="6.">
        If {a mathematical formula}w&lt;Ψ1w′ and {a mathematical formula}w≤Ψ2w′, then {a mathematical formula}w&lt;Ψ1⊔Ψ2w′
       </list-item>
      ...
      <paragraph>
       A quasi-syncretic assignment is a function mapping each profile Ψ to a total pre-order {a mathematical formula}≤Ψ over interpretations satisfying conditions 1–5 (above) plus the following condition (a weakening of condition 6):
      </paragraph>
      <list>
       <list-item label="6′">
        If {a mathematical formula}w&lt;Ψ1w′ and {a mathematical formula}w&lt;Ψ2w′, then {a mathematical formula}w&lt;Ψ1⊔Ψ2w′
      ...
      <paragraph>
       The following result establishes that the IC merging operators are represented by syncretic assignments.
      </paragraph>
      <paragraph label="Theorem 1">
       Konieczny–Pino Pérez's representation theoremAn operator Δ is an IC merging operator (IC quasi-merging operator respectively) if and only if there exists a syncretic assignment (quasi-syncretic assignment respectively) that maps each profile Φ to a total pre-order{a mathematical formula}≤Φsuch that:{a mathematical formula}
      </paragraph>
      <paragraph>
       This theorem allows to define semantically some families of IC merging operators using distances; for instance sum, Gmax and quasi max (see [17], [19] for details).
      </paragraph>
     </section>
     <section label="2.4">
      <section-title>
       Social choice functions and Arrow's impossibility theorem
      </section-title>
      <paragraph>
      ...
      <paragraph>
       Standard domain states that there are three or more alternatives and that the process of election gives always a result.
      </paragraph>
      <paragraph>
       Pareto condition says that if all the voters preferred the alternative x to the alternative y, and x is an available alternative, then the alternative y cannot be chosen.
      </paragraph>
      <paragraph>
       Independence of irrelevant alternatives states the following: if the voters express in different situations different preferences but these preferences coincide over the available alternatives, then in both situations the result has to be the same.
      </paragraph>
      <paragraph>
       Transitive explanations states that the process of election can be decomposed in two parts: first taking a preference of the group, and then taking the best available alternatives with respect to this group preference.
      </paragraph>
      <paragraph>
       Absence of dictator states that there is no voter (a dictator) which imposes his preferences. When a social choice function does not satisfy this property we say that it is dictatorial.
      </paragraph>
      <paragraph>
       The following result, due to Kenneth Arrow [2], [3], establishes that even if these properties seem very reasonable and democratically suitable, there is no social choice function satisfying all these properties together.
      </paragraph>
      <paragraph label="Theorem 2">
       Arrow's impossibility theoremAny social choice function that satisfies standard domain, Pareto condition, independence of irrelevant alternatives and transitive explanations is dictatorial.
      </paragraph>
      <paragraph>
       There are other interesting properties considered in the literature of social choice functions. We mention two properties that we will try to capture in the framework of epistemic state fusion: unanimity and non imposition.
      </paragraph>
      <list>
       <list-item>
        If {a mathematical formula}⪰i=⪰j, for each pair i, j in N, then {a mathematical formula}F(p,V)=max⁡(V,⪰i).
       </list-item>
      </list>
      <paragraph>
       Unanimity states that if the individual preferences coincide, the resulting choice is the set of alternatives preferred by the voters. Actually, if we replace Pareto condition by unanimity in Theorem 2, we obtain the same result; that is, if a social choice function satisfies standard domain, unanimity, independence of irrelevant alternatives and transitive explanations, necessarily it is dictatorial.
      </paragraph>
      <paragraph>
       Properties expressing the “richness” of possible results of the electoral process have been considered in the literature of social choice theory [12], [23], [4]. They are regrouped under the term of non imposition (see [26]). The following property was considered by Barberà [4]: Non-impositionFor any pair of alternatives {a mathematical formula}x,y in A there exists a profile p such that {a mathematical formula}F(p,{x,y})=x.
      </paragraph>
      <paragraph>
       This property states that between two alternatives, the voters can establish preferences in order to choose one of them.
      </paragraph>
     </section>
     <section label="2.5">
      <section-title>
       Similarities between belief merging and social choice theory
      </section-title>
      <paragraph>
       The following similarities between belief merging and social choice theory were pointed out by Konieczny and Pino Pérez [18]. The list can be seen as a 'dictionary' translating one framework into the other:
      </paragraph>
      <list>
       <list-item label="(a)">
        An alternative in belief merging, is an interpretation. Thus, the set of interpretations can be seen as the set of alternatives.
       </list-item>
       <list-item label="(b)">
        The voters correspond to the agents. They are determined in both frameworks by an index i.
       </list-item>
       <list-item label="(c)">
        The preferences of the voter i are encoded in belief merging by the belief base {a mathematical formula}φi. Thus profiles of preferences in social choice theory correspond to profiles in belief merging.
       </list-item>
       <list-item label="(d)">
        An agenda in social choice theory corresponds to an integrity constraint in belief merging.
       </list-item>
       <list-item label="(e)">
        A social choice function corresponds to a merging operator.
       </list-item>
       <list-item label="(f)">
        The fact that the chosen alternatives by a social choice function have to be a subset of the agenda corresponds to the satisfaction of the integrity constraints in belief merging.
       </list-item>
       <list-item label="(g)">
        The property of transitive explanations can be seen in belief merging as the representation Equation (2) of Theorem 1.
       </list-item>
      </list>
      <paragraph>
    ...
    <section label="3">
     ...
     <section label="3.1">
      ...
      <paragraph>
       From now on, we will suppose that N is the finite society {a mathematical formula}{i1,i2,…,in}, while the N-profiles Φ and {a mathematical formula}Φ′ will be denoted by {a mathematical formula}(Ei1,Ei2,…,Ein) and {a mathematical formula}(Ei1′,Ei2′,…,Ein′) respectively.
      </paragraph>
     </section>
     <section label="3.2">
      <section-title>
      ...
      <paragraph>
       We fix an epistemic space {a mathematical formula}(E,B,LP) and a set of agents {a mathematical formula}S. A function of the form {a mathematical formula}∇:P(S,E)×E⟶E will be called an epistemic state combination operator, for short an ES combination operator. {a mathematical formula}∇(Φ,E) represents the result of combining the epistemic states in Φ under the integrity constraints E.
      </paragraph>
      <paragraph>
       Now we establish the rationality postulates of fusion in the setting of epistemic states. Most of them are adapted from IC merging postulates proposed by Konieczny and Pino Pérez [16], [17], [18] (a first version of these postulates appeared in [21]). Since the beliefs of epistemic states constitute their only aspect with well known logical structure, we express the rationality postulates in logical terms at the level of beliefs. Some of these postulates are new mainly due to the new presentation of profiles as functions of finite societies into epistemic states.
      </paragraph>
      <paragraph>
       In order to introduce such postulates, let N and M be any pair of finite societies of agents in {a mathematical formula}S, Φ be any N-profile, {a mathematical formula}Φ′ be any M-profile, E, {a mathematical formula}E′, {a mathematical formula}E″ be any triple of epistemic states.
      </paragraph>
      <list>
       <list-item>
        {a mathematical formula}B(∇(Φ,E))⊢B(E).
       </list-item>
       <list-item>
        If{a mathematical formula}Φ≡Φ′and{a mathematical formula}B(E)≡B(E′)then{a mathematical formula}B(∇(Φ,E))≡B(∇(Φ′,E′))
       </list-item>
       <list-item>
        If{a mathematical formula}B(E)≡B(E′)∧B(E″)then{a mathematical formula}B(∇(Φ,E′))∧B(E″)⊢B(∇(Φ,E)).
       </list-item>
       <list-item>
        If{a mathematical formula}B(E)≡B(E′)∧B(E″)and{a mathematical formula}B(∇(Φ,E′))∧B(E″)⊬⊥, then{a mathematical formula}B(∇(Φ,E))⊢B(∇(Φ,E′))∧B(E″).
       </list-item>
      </list>
      <paragraph>
       (ESF1) tells us that the belief of the result has to be logically stronger than the belief of the restriction. This postulate corresponds to Postulate (IC1) of IC merging operators.
      </paragraph>
      <paragraph>
       (ESF2) is a weak form of the anonymity at the profile level and a syntax irrelevance property at the level of beliefs for the integrity restrictions. This postulate corresponds{sup:4} to Postulate (IC3) of IC merging operators.
      </paragraph>
      <paragraph>
       (ESF3) and (ESF4) together determine precisely the way in which the beliefs are chosen. They represent the condition that revision be accomplished with minimal change, stating that the notion of closeness is well-behaved. More precisely these postulates establish some conditions about integrity constraints' ‘conjunctions’. For instance, if an alternative A is chosen among a set of alternatives, then if the set of alternatives is narrowed, but the alternative A remains in this set, the alternative A will be still chosen. They correspond to postulates (IC7) and (IC8) of IC merging operators respectively.
      </paragraph>
      <paragraph>
       These four postulates, (ESF1)–(ESF4), are called basic epistemic state fusion postulates. They are considered the minimal requirements of rationality that the combination operators have to satisfy.
      </paragraph>
      <paragraph label="Definition 3">
       Basic fusion operatorsLet {a mathematical formula}(E,B,LP) be an epistemic space and let {a mathematical formula}S be a set of agents. A combination operator of epistemic states ∇ is said to be an epistemic state basic fusion operator (ES basic fusion operator for short) if it satisfies (ESF1)–(ESF4).
      </paragraph>
      <paragraph>
      ...
      <list>
       <list-item>
        If {a mathematical formula}Ej≠Ek, there exists {a mathematical formula}E′ in {a mathematical formula}E such that {a mathematical formula}B(∇(Ej,E′))≢B(∇(Ek,E′))
       </list-item>
       <list-item>
        If {a mathematical formula}{an inline-figure}i∈NB(Ei)∧B(E)⊬⊥, then {a mathematical formula}B(∇(Φ,E))≡{an inline-figure}i∈NB(Ei)∧B(E)
       </list-item>
       <list-item>
        {a mathematical formula}B(∇(Φ↾N1,E))∧B(∇(Φ↾N2,E))⊢B(∇(Φ,E))
       </list-item>
       <list-item>
        If {a mathematical formula}B(∇(Φ↾N1,E))∧B(∇(Φ↾N2,E))⊬⊥, then {a mathematical formula}B(∇(Φ,E))⊢B(∇(Φ↾N1,E))∧B(∇(Φ↾N2,E))
       </list-item>
      </list>
      <paragraph>
       (ESF5) is a new postulate. It says that given two different epistemic states, there is a restriction E that leads to different results at the level of beliefs, i.e. the beliefs of the result of the operator applied to each epistemic state with the restriction E, will not be equivalent.
      </paragraph>
      <paragraph>
       (ESF6) expresses that if all the agents of the profile agree at the level of beliefs with the restriction, this agreement will coincide with the belief resulting after application of the operator. This postulate corresponds to Postulate (IC2) of IC merging operators.
      </paragraph>
      <paragraph>
       (ESF7) tells us that for any partition of a group into two subgroups, the conjunction of belief of the result of applying the operator to each subgroup will be logically stronger than the beliefs resulting of applying the operator to the whole group. This postulate corresponds to Postulate (IC5) of IC merging operators.
      </paragraph>
      <paragraph>
       (ESF8) expresses that if we can divide a group into two subgroups such that the application of the operator to each subgroup leads to beliefs which are mutually consistent, then the conjunction of these beliefs will be the beliefs resulting of applying the operator to the whole group. This postulate corresponds to Postulate (IC6) of IC merging operators.
      </paragraph>
      <paragraph label="Definition 4">
       Epistemic state fusion operatorsLet ∇ be an ES combination operator. ∇ is said to be an epistemic state fusion operator (ES fusion operator for short) if it satisfies the postulates (ESF1)–(ESF8).
      </paragraph>
      <paragraph>
       There are some important variants of these operators coming from the satisfaction of some special postulates. These postulates are stated in what follows:
      </paragraph>
      <list>
       <list-item>
        If {a mathematical formula}B(∇(Φ↾N1,E))∧B(∇(Φ↾N2,E))⊬⊥, then {a mathematical formula}B(∇(Φ,E))⊢B(∇(Φ↾N1,E))∨B(∇(Φ↾N2,E))
      ...
      <paragraph>
       This property tells us that if a group is divided into two subgroups and, after application of the operator, the beliefs of the subgroups are consistent, then the beliefs of the whole group after application of the operator have to entail the disjunction of the beliefs of each subgroup. This postulate corresponds to Postulate (IC6′) of IC merging operators.
      </paragraph>
      <paragraph>
       Replacing the postulate (ESF8) by the weaker postulate (ESF8W), gives us the class of epistemic state quasifusion operators.
      </paragraph>
      <paragraph label="Definition 5">
       Epistemic state quasifusion operatorsLet ∇ be an ES combination operator. ∇ is said to be an epistemic state quasifusion operator (ES quasifusion operator for short) if it satisfies the postulates (ESF1)–(ESF7) and (ESF8W).
      </paragraph>
      <paragraph>
       Note that if an operator satisfies (ESF8), necessarily it satisfies (ESF8W). Thus, every ES fusion operator is an ES quasifusion operator. However, the converse is not true (see Section 5).
      </paragraph>
     </section>
     <section label="3.3">
      <section-title>
      ...
      <paragraph>
       An assignment is a function mapping epistemic state profiles into total preorders over interpretations. The intended meaning of these mappings is encoding semantically, in some sense, the group preference.
      </paragraph>
      <paragraph label="Definition 6">
       Assignment and basic assignmentLet {a mathematical formula}(E,B,LP) be an epistemic space and {a mathematical formula}S be a set of agents. An assignment is a function {a mathematical formula}f:P(S,E)→P(WP) mapping each epistemic profile Φ into {a mathematical formula}f(Φ), a total preorder over {a mathematical formula}WP. An assignment is called basic assignment when, for any profiles Φ and Ψ, if {a mathematical formula}Φ≡Ψ then {a mathematical formula}f(Φ)=f(Ψ).
      </paragraph>
      <paragraph>
       Given an assignment f, we will denote by {a mathematical formula}⪰Φ, the total preorder {a mathematical formula}f(Φ); and {a mathematical formula}Φ↦⪰Φ will denote the mapping f. The total preorder {a mathematical formula}⪰Φ can be seen as the group plausibility preference over worlds:
      </paragraph>
      <list>
       <list-item label="•">
        If {a mathematical formula}w⪰Φw′, we will say that w is at least as plausible as{a mathematical formula}w′, for the agents group in Φ
       </list-item>
       <list-item label="•">
        If {a mathematical formula}w≻Φw′, we will say that w is more plausible than{a mathematical formula}w′, for the agents group in Φ
       </list-item>
      </list>
      <paragraph>
       In order to have socially well behaved assignments, it is necessary to impose some rational properties. With the purpose of doing this, let j, k be a pair of agents in {a mathematical formula}S, N be any finite society of agents in {a mathematical formula}S, {a mathematical formula}{N1,N2} be any partition of N, Φ be any N-profile, {a mathematical formula}Ej be any j-profile, {a mathematical formula}Ek be any k-profile, and w, {a mathematical formula}w′ be any pair of interpretations in {a mathematical formula}WP.
      </paragraph>
      <list>
       <list-item>
        If {a mathematical formula}Ej≠Ek, then {a mathematical formula}⪰Ej≠⪰Ek
       </list-item>
       <list-item>
        If {a mathematical formula}{an inline-figure}i∈NB(Ei)⊬⊥, then {a mathematical formula}〚{an inline-figure}i∈NB(Ei)〛=max⁡(⪰Φ)
       </list-item>
       <list-item>
        If {a mathematical formula}w⪰Φ↾N1w′ and {a mathematical formula}w⪰Φ↾N2w′, then {a mathematical formula}w⪰Φw′
       </list-item>
       <list-item>
        If {a mathematical formula}w⪰Φ↾N1w′ and {a mathematical formula}w≻Φ↾N2w′, then {a mathematical formula}w≻Φw′
       </list-item>
      ...
      <paragraph>
       Property 1 imposes that different epistemic states lead to different total preorders (injectivity of the assignment restricted to profile of size one).
      </paragraph>
      <paragraph>
       Property 2 tells us that, if there are models of the conjunction of the beliefs of the epistemic states of the profile, they are exactly the maximal models of the total preorder associated to the profile.
      </paragraph>
      <paragraph>
       Property 3 expresses that if one model {a mathematical formula}w1 is at least as plausible as {a mathematical formula}w2 for one group, and the same occurs for a second group, then for the group resulting of the union of these groups, {a mathematical formula}w1 will be at least as plausible as {a mathematical formula}w2.
      </paragraph>
      <paragraph>
       Property 4 is similar to the previous one, except that if there is one preference strict for one of the subgroups, this will be the case for the whole group.
      </paragraph>
      <paragraph>
       We think that the most entrenched preferences should represent the beliefs. This is expressed more precisely by the following property:
      </paragraph>
      ...
      <paragraph>
       Note that any assignment {a mathematical formula}Φ↦⪰Φ satisfying Property 2, with respect to B, satisfies the maximality condition. Moreover, in presence of Properties 3 and 4, we have that Property 2 is equivalent to the maximality condition.
      </paragraph>
      <paragraph label="Proposition 1">
       Let{a mathematical formula}(E,B,LP)be an epistemic space and{a mathematical formula}Sbe a set of agents. Suppose that the assignment{a mathematical formula}Φ↦⪰Φsatisfies Properties3and4. Then{a mathematical formula}Φ↦⪰Φsatisfies Property2if, and only if, it satisfies the maximality condition.
      </paragraph>
      <paragraph>
       The previous result shows some hidden connections between Properties 2, 3 and 4 under the maximality condition. Actually, under maximality condition, Properties 3 and 4 entail Property 2. However the converse does not hold as we will observe in Section 5.
      </paragraph>
      <paragraph>
       The properties previously stated, together determine when an assignment has a good social behavior.
      </paragraph>
      <paragraph label="Definition 8">
       Faithful assignmentLet {a mathematical formula}(E,B,LP) be an epistemic space and {a mathematical formula}S be a set of agents. An assignment {a mathematical formula}Φ↦⪰Φ is called a faithful assignment, with respect to B, if it is a basic assignment which satisfies Properties 1–4.
      </paragraph>
      <paragraph>
       The following property is weaker than Property 4:
      </paragraph>
      <list>
       <list-item>
        If {a mathematical formula}w≻Φ↾N1w′ and {a mathematical formula}w≻Φ↾N2w′ then {a mathematical formula}w≻Φw′
      ...
      <paragraph>
       This expresses that given two alternatives, {a mathematical formula}w,w′, if for one of the groups, w is more plausible than {a mathematical formula}w′, and the same relation occurs for other group, then, putting the groups together, w is still more plausible than {a mathematical formula}w′.
      </paragraph>
      <paragraph>
       Note that Property 4 entails Property 4′. However, the converse is not true as we will see in Section 5.
      </paragraph>
      <paragraph>
       Replacing Property 4 by Property 4′ in the definition of faithful assignments gives us another important class of assignments:
      </paragraph>
      <paragraph label="Definition 9">
       Quasifaithful assignmentLet {a mathematical formula}(E,B,LP) be an epistemic space and {a mathematical formula}S be a set of agents. An assignment {a mathematical formula}Φ↦⪰Φ is called a quasifaithful assignment, with respect to B, if it is a basic assignment in which Properties 1–3 and 4′ hold.
      </paragraph>
     </section>
     <section label="3.4">
      <section-title>
      ...
      <paragraph>
       We present some results which help to understand the behavior of the operators defined previously. This allows us to describe the operators, at least partially, in a semantical way. Thus, we call these results weak representation by opposition to some results of representation in concrete structures like in [21], where we can effectively build the operator starting from an assignment.
      </paragraph>
      <paragraph label="Theorem 3">
       Weak representation for ES basic fusion operatorsAn ES combination operator ∇ is an ES basic fusion operator iff there exists a unique basic assignment{a mathematical formula}Φ↦⪰Φsuch that:{a mathematical formula}
      </paragraph>
      <paragraph>
       This result generalizes Theorem 1 when the representation of epistemic states is just given by belief bases. Of course it applies to more general representations of epistemic states. Even if the postulates involved in the previous theorem do not make explicit mention of additional information of epistemic states, it allows the possibility of having postulates which make explicit mention of additional information of epistemic states. That will be the case of social postulates in Section 4.1, especially the standard domain postulate therein (cf. Theorem 6 and the comments just after it).
      </paragraph>
      <paragraph>
       It is worth to note that we can obtain a variant of this result with a weak version of (ESF2) where the equivalence between profiles is not necessary, just like the version presented in [21]. More precisely, the operators satisfying this weak version of (ESF2) plus (ESF1), (ESF3) and (ESF4), are exactly the operators weakly represented by a simple assignment.
      </paragraph>
      <paragraph>
       The weak representation theorem allows us to obtain very tight relations between the (syntactical) postulates for fusion and the properties of the assignments. More precisely, we have the following result:
      </paragraph>
      <paragraph label="Proposition 2">
       Let ∇ be an ES basic fusion operator and{a mathematical formula}Φ↦⪰Φbe the basic assignment associated to ∇ byTheorem 3. Then, the following conditions hold:
      </paragraph>
      <list>
       <list-item label="(i)">
        ∇ satisfies(ESF5)iff{a mathematical formula}Φ↦⪰Φsatisfies1.
       </list-item>
       <list-item label="(ii)">
        ∇ satisfies(ESF6)iff{a mathematical formula}Φ↦⪰Φsatisfies2.
       </list-item>
       <list-item label="(iii)">
        ∇ satisfies(ESF7)iff{a mathematical formula}Φ↦⪰Φsatisfies3.
       </list-item>
       <list-item label="(iv)">
        ∇ satisfies(ESF8)iff{a mathematical formula}Φ↦⪰Φsatisfies4.
       </list-item>
       <list-item label="(v)">
        ∇ satisfies(ESF8W)iff{a mathematical formula}Φ↦⪰Φsatisfies4′.
       </list-item>
      </list>
      <paragraph>
       The next two theorems are important representation results. They are straightforward consequences of Proposition 2.
      </paragraph>
      <paragraph label="Theorem 4">
       Weak representation for ES fusion operatorsAn ES combination operator ∇ is an ES fusion operator iff there exists a unique faithful assignment{a mathematical formula}Φ↦⪰Φsatisfying(B-Rep).
      </paragraph>
      <paragraph label="Theorem 5">
       Weak representation for ES quasifusion operatorsAn ES combination operator ∇ is an ES quasifusion operator iff there exists a unique quasifaithful assignment{a mathematical formula}Φ↦⪰Φsatisfying(B-Rep).
      </paragraph>
      <paragraph>
       Unlike the representation theorem for IC merging operators [17], [19], the previous theorems do not allow the construction of ∇ from the basic assignment. However, they allow the representation of the beliefs of the result via the total preorders of the assignment.
      </paragraph>
     </section>
    </section>
    <section label="4">
     <section-title>
      Impossibility in epistemic fusion
     </section-title>
     <paragraph>
      We would like the fusion process to have properties guaranteeing more global satisfaction. These good properties are based in the following principles:
     </paragraph>
     <list>
      <list-item label="a.">
       Any result is possible in the framework of the restrictions of the system.
      </list-item>
      <list-item label="b.">
       If all the agents have the same epistemic state it is this state which determines the result of the fusion.
      </list-item>
      <list-item label="c.">
       The fusion process depends only on how the restrictions are related in the individual epistemic states.
      </list-item>
      <list-item label="d.">
       The group belief base, obtained as the result of the fusion process, does not depend on one unique agent.
      </list-item>
     </list>
     <paragraph>
      Unfortunately, as we will see in this section, all these principles cannot coexist. More precisely, we will prove that for a fusion process satisfying the three first principles, necessarily there exists an agent that will impose his beliefs.
     </paragraph>
     <paragraph>
      Next, we formulate the above principles in logical terms based on our operators over epistemic states.
     </paragraph>
     <section label="4.1">
      <section-title>
       Other social properties for fusion operators
      </section-title>
      <paragraph>
      ...
      <list>
       <list-item>
        For any i in {a mathematical formula}S, for any triple of interpretations w, {a mathematical formula}w′ and {a mathematical formula}w″ in {a mathematical formula}WP, and any couple of epistemic states {a mathematical formula}Ew,w′ and {a mathematical formula}Ew′,w″, such that {a mathematical formula}〚B(Ew,w′)〛={w,w′} and {a mathematical formula}〚B(Ew′,w″)〛={w′,w″}, the following conditions hold:
       </list-item>
      </list>
      <paragraph>
       (ESF-SD) states that given an integrity constraint whose beliefs have at most two models, a voter can express preferences in order to have a resulting epistemic state such that the models of its beliefs could be any subset of the set of models of the beliefs of the integrity constraint. Actually, this postulate is related to the non-imposition property in social choice theory (see Section 2.4).
      </paragraph>
      <paragraph label="Observation 1">
       It is worth noting that for basic fusion operators (those satisfying Theorem 3), the satisfaction of this postulate is equivalent to the following fact: for any agent i in {a mathematical formula}S, any triple of interpretations w, {a mathematical formula}w′ and {a mathematical formula}w″ in {a mathematical formula}WP, and any total preorder ⪰ between these interpretations (except the flat order), there is an i-profile {a mathematical formula}Ei such that {a mathematical formula}⪰=⪰Ei↾{w,w′,w″}.
      </paragraph>
      <paragraph>
      ...
      <list>
       <list-item label="(i)">
        For all j in{a mathematical formula}S, there exists a j-profile{a mathematical formula}Ejsuch that
       </list-item>
       <list-item label="(ii)">
        For all k in{a mathematical formula}S, there exists a k-profile{a mathematical formula}Eksuch that
       </list-item>
      </list>
      <paragraph>
      ...
      <list>
       <list-item>
        For all N in{a mathematical formula}F⁎(S), for each N-profile Φ and for every epistemic state E in{a mathematical formula}E, if{a mathematical formula}Ei=Ej, for any pair i, j in N, then, for all i in N,{a mathematical formula}B(∇(Φ,E))≡B(∇(Ei,E)).
       </list-item>
      </list>
      <paragraph>
       (ESF-U) establishes that if all the agents in the society have the same epistemic state, then the result of the fusion is exactly the fusion (or the revision{sup:6}) of the society conformed by any of the agents given the integrity constraints.
      </paragraph>
      <paragraph>
       The following result is important. It establishes that the ES fusion operators satisfy the unanimity condition.
      </paragraph>
      <paragraph label="Proposition 4">
       Let ∇ be an ES combination operator. If ∇ satisfies(ESF2),(ESF7)and(ESF8), it satisfies(ESF-U).
      </paragraph>
      <paragraph>
       The converse of this result does not hold, as can be seen in Section 5.
      </paragraph>
      <paragraph>
       In the following result we give a semantic characterization of the unanimity condition.
      </paragraph>
      <paragraph label="Proposition 5">
       Let ∇ be an ES basic fusion operator. Then the following statements are equivalent:
      </paragraph>
      <list>
       <list-item label="(i)">
        ∇ satisfies(ESF-U).
       ...
       <list-item label="(ii)">
        For all N in{a mathematical formula}F⁎(S), for each N-profile Φ, for every epistemic state E in{a mathematical formula}Esuch that{a mathematical formula}|〚B(E)〛|≤2, if{a mathematical formula}Ei=Ejfor each pair i, j in N, then{a mathematical formula}B(∇(Φ,E))≡B(∇(Ei,E)), for all i in N.
       </list-item>
       <list-item label="(iii)">
        The assignment{a mathematical formula}Φ↦⪰Φ, representing ∇, satisfies the following property:
       </list-item>
      </list>
      <paragraph>
       Note that this last condition is closer to the formulations of unanimity in social choice theory.
      </paragraph>
      <paragraph>
      ...
      <list>
       <list-item>
        For all N in{a mathematical formula}F⁎(S), for each N-profile Φ, for all epistemic states E and{a mathematical formula}E′in{a mathematical formula}E, if{a mathematical formula}{an inline-figure}i∈NB(∇(Ei,E))⊬⊥and{a mathematical formula}B(∇(Ei,E))∧B(E′)⊢⊥for all i in N, then{a mathematical formula}B(∇(Φ,E))∧B(E′)⊢⊥.
       </list-item>
      </list>
      <paragraph>
      ...
      <paragraph label="Proposition 6">
       If ∇ is an ES combination operator that satisfies(ESF7)and(ESF8W), then ∇ also satisfies(ESF-P).
      </paragraph>
      <paragraph>
       The converse is not true as will be seen in Section 5.
      </paragraph>
      <paragraph>
       The Pareto condition has also a semantical characterization that we give in the next result:
      </paragraph>
      ...
      <list>
       ...
       <list-item label="(ii)">
        For all N in{a mathematical formula}F⁎(S), for every N-profile Φ, for all epistemic states E and{a mathematical formula}E′in{a mathematical formula}Esuch that{a mathematical formula}|〚B(E)〛|≤2, if{a mathematical formula}B(∇(Ei,E))∧B(E′)⊢⊥for all i in N, then{a mathematical formula}B(∇(Φ,E))∧B(E′)⊢⊥
       </list-item>
       <list-item label="(iii)">
        The assignment{a mathematical formula}Φ↦⪰Φ, representing ∇, satisfies the following property:
       </list-item>
      ...
      <list>
       ...
       <list-item label="(ii)">
        For all N in{a mathematical formula}F⁎(S), for all N-profiles Φ and{a mathematical formula}Φ′, for all E in{a mathematical formula}Esuch that{a mathematical formula}|〚B(E)〛|≤2, if{a mathematical formula}B(∇(Ej,E))≡B(∇(Ej′,E)), for all j in N, then{a mathematical formula}B(∇(Φ,E))≡B(∇(Φ′,E))
       </list-item>
       <list-item label="(iii)">
        The assignment{a mathematical formula}Φ↦⪰Φ, representing ∇, satisfies the following property:
       </list-item>
      ...
      <paragraph>
       It is worth noting that in presence of (ESF-I) and the basic postulates, Postulate (ESF-U) entails (ESF-P), i.e. unanimity is stronger than Pareto condition. That is the following proposition:
      </paragraph>
      <paragraph label="Proposition 9">
       If an ES basic fusion operator ∇ satisfies(ESF-U)and(ESF-I), then it also satisfies(ESF-P).
      </paragraph>
      <paragraph>
      ...
      <list>
       <list-item>
        For all N in{a mathematical formula}F⁎(S)there exists an agent{a mathematical formula}dNin N such that, for all N-profile Φ and for all epistemic state E in{a mathematical formula}E,{a mathematical formula}B(∇(Φ,E))⊢B(∇(EdN,E)).
       </list-item>
      </list>
      <paragraph>
       The operators satisfying the previous postulate are called dictatorial operators. Suppose that the operator ∇ is dictatorial, then given N in {a mathematical formula}F⁎(S), an agent {a mathematical formula}dN satisfying the property in (ESF-D), is called a dictador in N or simply N-dictator, with respect to ∇.
      </paragraph>
      <paragraph>
      ...
      <list>
       ...
       <list-item label="(ii)">
        For all N in{a mathematical formula}F⁎(S), there exists{a mathematical formula}dNin N such that, for every N-profile Φ and for all epistemic state E in{a mathematical formula}E, if{a mathematical formula}|〚B(E)〛|≤2then{a mathematical formula}B(∇(Φ,E))⊢B(∇(EdN,E)).
       </list-item>
       <list-item label="(iii)">
        The assignment{a mathematical formula}Φ↦⪰Φ, representing ∇, satisfies the following property:
       </list-item>
      ...
      <paragraph label="Proposition 11">
       Let ∇ be an ES combination operator. If ∇ satisfies(ESF-D), then ∇ satisfies(ESF-P).
      </paragraph>
      <paragraph>
       However, there are dictatorial operators for which (ESF-U) does not hold (see Section 5).
      </paragraph>
     </section>
     <section label="4.2">
      <section-title>
      ...
      <paragraph>
       There exist some links between standard domain, unanimity, Pareto, independence conditions and the fact that a merging process admits a dictatorial agent. Such links are revealed through the main impossibility theorem below. This theorem shows that if standard domain, Pareto and independence conditions hold, an ES basic fusion operator is really a dictatorial operator.
      </paragraph>
      <paragraph label="Theorem 7">
       Main impossibility theoremLet ∇ be an ES basic fusion operator. If ∇ satisfies(ESF-SD),(ESF-P)and(ESF-I), then(ESF-D)holds.
      </paragraph>
      <paragraph>
       Note that the condition of transitive explanations in social choice theory (see Section 2.4) is actually implicit in the representation of ES basic fusion operators; indeed, these operators are represented by the basic assignment which corresponds to the social welfare function in social choice theory (see Table 1).
      </paragraph>
      <paragraph>
       Postulates (ESF-SD), (ESF-P) and (ESF-I) are only sufficient conditions in order to have an ES basic fusion operator be dictatorial. Actually, as we will see in Section 5, there exist ES basic fusion operators that satisfy (ESF-D) but do not satisfy (ESF-I), namely the Σ-pseudoprojective ES fusion operators. There are also dictatorial operators which do not satisfy (ESF-SD), namely the linearized projective operators (see Section 5).
      </paragraph>
      <paragraph>
       By the connection between the postulates established in Section 3 and the Pareto condition which has been revealed in Proposition 6 and the main impossibility theorem we have:
      </paragraph>
      <paragraph label="Corollary 1">
       Any ES basic fusion operator that satisfies(ESF-SD),(ESF7),(ESF8W)(or(ESF8)) and(ESF-I), also satisfies(ESF-D).
      </paragraph>
      <paragraph>
       Similarly, by virtue of the relationship between the unanimity and Pareto conditions, from Proposition 9 and the main impossibility theorem we have the following corollary:
      </paragraph>
      <paragraph label="Corollary 2">
       Any ES basic fusion operator that satisfies(ESF-SD),(ESF-U)and(ESF-I), also satisfies(ESF-D).
      </paragraph>
     </section>
    </section>
    <section label="5">
     <section-title>
      Concrete examples of ES basic fusion operators
     </section-title>
     <paragraph>
      In this section we assume that the epistemic states are total preorders over interpretations and we have {a mathematical formula}〚B(⪰)〛=max⁡(⪰) for any epistemic state ⪰. Then, with this concrete representation of epistemic states, we will define some ES basic fusion operators.
     </paragraph>
     <section label="5.1">
      <section-title>
       Some classes of ES basic fusion operators
      </section-title>
      <paragraph>
       First, we are going to define a class of ES basic fusion operators using aggregation functions. These operators are called aggregation-based ES fusion operators. In order to do this, let us recall the definition of aggregation functions.
      </paragraph>
      <paragraph label="Definition 10">
       Aggregation functionsAn (symmetric) aggregation function F is a total function associating a nonnegative real number to every finite tuple of nonnegative integers such that for any {a mathematical formula}x1,...,xn,x,y in {a mathematical formula}Z+: Monotony{a mathematical formula}F(x1,…,x,…,xn)≥F(x1,…,y,…,xn), if {a mathematical formula}x≥yMinimality{a mathematical formula}F(x1,x2,…,xn)=0 if and only if {a mathematical formula}x1=x2=⋯=xn=0Identity{a mathematical formula}F(x)=xSymmetryFor any permutation σ, {a mathematical formula}F(x1,x2,…,xn)=F(σ(x1,x2,…,xn))
      </paragraph>
      <paragraph>
       Two examples of aggregation functions are sum and max. They are classic examples in the study of logic-based fusion [17].
      </paragraph>
      <list>
       <list-item>
        {a mathematical formula}∑(x1,x2,⋯,xn)=∑xi
       </list-item>
       <list-item>
        {a mathematical formula}max⁡(x1,x2,…,xn)=max⁡{x1,x2,…,xn}
       </list-item>
      </list>
      <paragraph>
       An aggregation function F induces a total preorder over {a mathematical formula}WP, for any profile of epistemic states as follows:
      </paragraph>
      <paragraph>
      ...
      <paragraph>
       From the definition (3), in addition to the equations (1) and (B-Rep), it is possible to build an ES basic fusion operator {a mathematical formula}∇F associated to an aggregation function F as follows:{a mathematical formula}
      </paragraph>
      <paragraph>
       Thanks to the equation above we define two aggregation-based ES basic fusion operators: {a mathematical formula}∇Σ (sum) and {a mathematical formula}∇max (max), defined from the aggregation functions sum and max respectively.
      </paragraph>
      <paragraph>
       Another class of ES combination operators are given in terms of projections or variants of this. The operators in this class are called projective-based ES fusion operators. In order to define this class, from now on, {a mathematical formula}dN denotes {a mathematical formula}max⁡(N) for each finite society N of agents in {a mathematical formula}S.
      </paragraph>
      <paragraph>
       The first one of such operators is determined by projections over profiles of epistemic states. This operator is called projective ES basic fusion operator, {a mathematical formula}∇π (projective operator by abuse of notation), and is defined as follows:
      </paragraph>
      <list>
       <list-item>
        {a mathematical formula}
    ...
    <section label="6">
     ...
     <list>
      <list-item label="(a)">
       If F satisfies Pareto, then{a mathematical formula}∇Fsatisfies(ESF-P{sup:⁎}), restricted to{a mathematical formula}W⁎,{a mathematical formula}E⁎and N.
      </list-item>
      <list-item label="(b)">
       If F satisfies independence of irrelevant alternatives, then{a mathematical formula}∇Fsatisfies(ESF-I{sup:⁎}), restricted to{a mathematical formula}W⁎,{a mathematical formula}E⁎and N.
      </list-item>
      <list-item label="(c)">
       If{a mathematical formula}∇Fsatisfies(ESF-D{sup:⁎}), restricted to{a mathematical formula}W⁎,{a mathematical formula}E⁎and N, then F is a dictatorial social choice function.
      </list-item>
     </list>
     <paragraph>
      Straightforwardly from this last result together with Observation 2 and Theorem 8, we obtain Arrow's theorem (Theorem 2) as a corollary.
     </paragraph>
    </section>
   </content>
   <appendices>
    <section label="Appendix A">
     <section-title>
      Coalitions and decisional power
     </section-title>
     <paragraph>
      In many situations a group of agents or individuals who integrate a society form alliances or coalitions in order to achieve common goals. Thus, in a first step to define important types of alliances, we will say simply that a coalition is determined by a group of individuals of a society. More precisely, we state:
     </paragraph>
     <paragraph label="Definition 11">
      CoalitionsGiven a finite society of agents N in {a mathematical formula}F⁎(S), a coalition of agents in N, or simply an N-coalition, is a set D of agents in N.
     </paragraph>
     <paragraph>
      Some coalitions in logic-based fusion have an important decisional power. This kind of decisional power can be illustrated as follows: Let us suppose that the agents of a society have to decide about the acceptation of certain information under some given condition (integrity constraints). Also suppose that, under such restriction, the new information does not satisfy some of the agents (the coalition) at all, and the rest of the agents accept this information. When the global decision is to reject the new information, it is clear that the coalition has imposed its view. This kind of coalitions, with great decisional power, are called locally decisive coalitions.
     </paragraph>
     <paragraph label="Definition 12">
      Locally decisive coalitionsLet N be in {a mathematical formula}F⁎(S), ∇ be an ES combination operator, E, {a mathematical formula}E′ be a pair of epistemic states and D be an N-coalition. We say that D is a locally decisive N-coalition for E against {a mathematical formula}E′, with respect to ∇, denoted by {a mathematical formula}ED∇E′, if for each N-profile Φ satisfying:
     </paragraph>
     <list>
      <list-item label="(i)">
       {a mathematical formula}B(∇(Ei,E))∧B(E′)⊢⊥, for all i in D;
      </list-item>
      <list-item label="(ii)">
       {a mathematical formula}B(∇(Ej,E))⊢B(E′), for all j in {a mathematical formula}N∖D; and
      </list-item>
      <list-item label="(iii)">
       {a mathematical formula}{an inline-figure}i∈DB(∇(Ei,E))⊬⊥
      </list-item>
     </list>
     <paragraph>
      It is also possible that the rejection of the new information will be achieved by a coalition independently from the opinion of the rest of the agents involved in the merging process. This kind of coalitions are called decisive coalitions.
     </paragraph>
     <paragraph label="Definition 13">
      Decisive coalitionLet N be in {a mathematical formula}F⁎(S), ∇ be an ES combination operator, E, {a mathematical formula}E′ be a pair of epistemic states and D be an N-coalition. We say that D is a decisive N-coalition for E against {a mathematical formula}E′, with respect to ∇, denoted by {a mathematical formula}ED∇⁎E′, if for every N-profile Φ satisfying:
      <list>
       {a mathematical formula}B(∇(Ei,E))∧B(E′)⊢⊥, for all i in D; and{a mathematical formula}{an inline-figure}i∈DB(∇(Ei,E))⊬⊥We will say that
      </list>
      <paragraph>
       D is a decisive N-coalition, with respect to ∇, if {a mathematical formula}ED∇⁎E′ for any pair E, {a mathematical formula}E′ of epistemic states.
      </paragraph>
     </paragraph>
     <paragraph label="Observation 3">
      For any finite society N in {a mathematical formula}F⁎(S), any ES combination operator ∇, any N-coalition D and any tuple of epistemic states E, {a mathematical formula}E′, {a mathematical formula}E‾, {a mathematical formula}E′‾ in {a mathematical formula}E, it is easy to see that the following conditions hold:
     </paragraph>
     <list>
      <list-item label="a.">
       If {a mathematical formula}ED∇⁎E′, then {a mathematical formula}ED∇E′
      </list-item>
      <list-item label="b.">
       If ∇ satisfies (ESF1) and {a mathematical formula}B(E)≡B(E′), or {a mathematical formula}B(E) is inconsistent with {a mathematical formula}B(E′), then {a mathematical formula}ED∇⁎E′ and therefore {a mathematical formula}ED∇E′
      </list-item>
      <list-item label="c.">
       If ∇ satisfies (ESF2), {a mathematical formula}B(E)≡B(E‾) and {a mathematical formula}B(E′)≡B(E′‾), then {a mathematical formula}ED∇⁎E′ if, and only if, {a mathematical formula}E‾D∇⁎E′‾
      </list-item>
      <list-item label="d.">
       If ∇ satisfies (ESF1) and D is decisive, then D is nonempty.{sup:7}
      </list-item>
      <list-item label="e.">
       If ∇ satisfies (ESF-P), then N is a decisive N-coalition by itself.
      </list-item>
     </list>
     <paragraph>
     ...
     <paragraph label="Proposition 13">
      Let ∇ be an ES combination operator. Let N be a finite society of agents. If D is a decisive N-coalition and its cardinality is one, then the only element of D is a dictator in N.
     </paragraph>
     <paragraph>
      Next, we introduce the first result about decisive coalition. It establishes some necessary and sufficient conditions that must be satisfied by a basic assignment, associated to certain ES basic fusion operator, in order for it to admit a decisive coalition. Due to the similarity between the Pareto condition and the decisive coalition notion, the proof of this result is analogue to that of Proposition 7.
     </paragraph>
     <paragraph label="Proposition 14">
      Given N in{a mathematical formula}F⁎(S), ∇ an ES basic fusion operator and{a mathematical formula}Φ↦⪰Φthe basic assignment associated to ∇, the following claims about an N-coalition D are equivalent:
     </paragraph>
     <list>
      <list-item label="(i)">
       D is a decisive N-coalition, with respect to ∇.
      </list-item>
      <list-item label="(ii)">
       For each N-profile Φ and any pair of epistemic states E,{a mathematical formula}E′in{a mathematical formula}E, if{a mathematical formula}|〚B(E)〛|≤2and{a mathematical formula}B(∇(Ei,E))∧B(E′)⊢⊥, for all i in D, then{a mathematical formula}B(∇(Φ,E))∧B(E′)⊢⊥.
      </list-item>
      <list-item label="(iii)">
       For each N-profile Φ, and all interpretations w,{a mathematical formula}w′, if{a mathematical formula}w≻Eiw′, for all i in D, then{a mathematical formula}w≻Φw′.
      </list-item>
     </list>
     <paragraph>
      Let us note that the last result, in addition to giving a semantic characterization of operators that admit decisive coalitions (point (iii)), establishes that in order to determine the decisive nature of a coalition with respect to an ES basic operator, it is enough considering epistemic states whose most entrenched beliefs have at most two models (point (ii)).
     </paragraph>
     <paragraph>
      Under certain rational properties over a merging process, if a coalition is locally decisive between a pair of epistemic states of a certain kind, then we can change slightly the pair of epistemic states and the coalition will continue to be locally decisive for this new pair of epistemic states. More precisely, we have the following two results:
     </paragraph>
     ...
     <paragraph>
      The previous two propagation results will allow us to show that if a coalition is locally decisive with respect to a given pair of epistemic states then such coalition is decisive. More precisely we have the following theorem:
     </paragraph>
     <paragraph label="Proposition 17">
      Generalized propagationConsider N in{a mathematical formula}F⁎(S), let ∇ be an ES basic fusion operator satisfying(ESF-SD),(ESF-P)and(ESF-I), and D be an N-coalition. If there exist different interpretations w and{a mathematical formula}w′, and epistemic states{a mathematical formula}Ew,w′and{a mathematical formula}Ew′, such that{a mathematical formula}〚B(Ew,w′)〛={w,w′},{a mathematical formula}〚B(Ew′)〛={w′}and{a mathematical formula}Ew,w′D∇Ew′, then D is a decisive coalition.
     </paragraph>
    </section>
