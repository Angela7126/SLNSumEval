   ...
   <content>
    ...
    <section label="2">
     ...
     <section label="2.1">
      ...
      <paragraph>
       In contrast to many other clustering problems, deciding the number of clusters is in the most general case part of the correlation clustering problem. However, as every point is assigned to exactly one cluster, in practice it is enough to search over all functions {a mathematical formula}cl:V→{1,…,N}.
      </paragraph>
     </section>
     <section label="2.2">
      <section-title>
       On the assumption of symmetric similarities
      </section-title>
    ...
    <section label="3">
     <section-title>
      Correlation clustering as integer linear programming
     </section-title>
     <paragraph>
    ...
    <section label="6">
     <section-title>
      A MaxSAT formulation of correlation clustering: transitive encoding
     </section-title>
     <paragraph>
    ...
    <section label="8">
     ...
     <list>
      <list-item label="•">
       {a mathematical formula}EQijk, where {a mathematical formula}1≤i&lt;j≤N, {a mathematical formula}W(i,j)∈R∖{0}, and {a mathematical formula}1≤k≤a. The intended semantics of {a mathematical formula}EQijk is {a mathematical formula}EQijk=1 iff {a mathematical formula}bik=bjk.
      </list-item>
      <list-item label="•">
       {a mathematical formula}Sij, where {a mathematical formula}1≤i&lt;j≤N and {a mathematical formula}W(i,j)∈R∖{0}. {a mathematical formula}Sij=1 iff points {a mathematical formula}vi and {a mathematical formula}vj are co-clustered. (Note the equivalence: also, if {a mathematical formula}Sij=0, then points {a mathematical formula}vi and {a mathematical formula}vj are not assigned to the same cluster.)
      </list-item>
     </list>
     <paragraph>
    ...
    <section label="9">
     ...
     <section label="9.1">
      ...
      <section label="9.1.2">
       ...
       <list>
        <list-item label="•">
         ORL: the AT&amp;T ORL database of images of faces, each of size {a mathematical formula}92×112. Obtained from http://www.cl.cam.ac.uk/research/dtg/attarchive/facedatabase.html.
        </list-item>
        <list-item label="•">
        ...
        <list-item label="•">
         Umist: the Sheffield (previously UMIST) Face Database, each face image of size {a mathematical formula}92×112. Obtained from http://www.sheffield.ac.uk/eee/research/iel/research/face.
        </list-item>
        <list-item label="•">
     ...
     <section label="9.2">
      <section-title>
       Experiments on unconstrained correlation clustering
      </section-title>
      <paragraph>
      ...
      <section label="9.2.1">
       <section-title>
        Comparison of algorithms providing optimal solutions
       </section-title>
       <paragraph>
     ...
     <section label="9.4">
      ...
      <section label="9.4.1">
       <section-title>
        Effects of MaxSAT preprocessing
       </section-title>
       <paragraph>
      ...
      <section label="9.4.3">
       <section-title>
        A comparison of MaxSAT solvers
       </section-title>
       <paragraph>
        In the main experiments reported in this work, we used the MaxHS MaxSAT solver, which has shown very good performance especially in the “crafted” category of the recent MaxSAT Evaluations.{sup:7} Here we report on the performance of other state-of-the-art MaxSAT solvers, using the following solvers.
       </paragraph>
       <list>
        <list-item label="•">
    ...
    <section label="Appendix A">
     ...
     <section label="A.2">
      ...
      <section label="A.2.2">
       ...
       <paragraph label="Proof">
        Condition 3 of Proposition 1Let{a mathematical formula}cl:V→{1,2,…,K}be any clustering of V that respects the infinite values of W. There is a solution τ to{a mathematical formula}F2such that{a mathematical formula}cl=clτ.We construct such a τ. For each {a mathematical formula}1≤i≤N and {a mathematical formula}1≤k≤K, let{a mathematical formula}{a mathematical formula} Clearly {a mathematical formula}cl=clτ as long as τ is a solution to {a mathematical formula}F2. We show that it is by considering the different types of hard constraints present in {a mathematical formula}F2.
       </paragraph>
       <list>
        <list-item label="1.">
         Since cl is well-defined, there is exactly one k for which {a mathematical formula}cl(vi)=k for each {a mathematical formula}vi. Hence {a mathematical formula}τ(ExactlyOne(i))=1 for all {a mathematical formula}vi∈V.
        </list-item>
        <list-item label="2.">
         By construction {a mathematical formula}τ(Aijk)=τ(yik∧yjk) for all similar {a mathematical formula}vi, {a mathematical formula}vj and k. Hence {a mathematical formula}τ(HardSimilar(i,j,k))=1.
        </list-item>
        <list-item label="3.">
        ...
        <list-item label="5.">
         For all {a mathematical formula}W(i,j)=−∞ we have that {a mathematical formula}cl(vi)≠cl(vj). Hence either {a mathematical formula}cl(vi)≠k or {a mathematical formula}cl(vj)≠k for all k. By the construction of τ it follows that {a mathematical formula}τ(¬yik∨¬yjk)=1 and {a mathematical formula}τ(CLU(vi,vj))=1.
        </list-item>
       </list>
       <paragraph label="Proof">
      ...
      <section label="A.2.3">
       <section-title>
        Correctness of the binary encoding
       </section-title>
       <paragraph label="Proof">
       ...
       <list>
        ...
        <list-item label="2.">
         For any {a mathematical formula}W(i,j)&lt;∞, {a mathematical formula}W(i,j)≠0, and any bit n position, it holds that{a mathematical formula} Hence {a mathematical formula}τ(Equality(i,j,m))=1.
        </list-item>
        <list-item label="3.">
         For any {a mathematical formula}W(i,j)≠0 and {a mathematical formula}W(i,j)∈R, it holds that{a mathematical formula} Hence {a mathematical formula}τ(SameCluster(i,j))=1.
        </list-item>
        <list-item label="4.">
