  ...
  <root>
   ...
   <content>
    ...
    <section label="2">
     ...
     <section label="2.1">
      <section-title>
       First-order normal logic program
      </section-title>
      <paragraph>
     ...
     <section label="2.2">
      <section-title>
       The translational stable model definition
      </section-title>
      <paragraph>
     ...
     <section label="2.3">
      ...
      <paragraph label="Definition 2">
       Clark's completionLet Π be a program. Clark's Completion (completion for short if clear from the context) of Π, denoted by {a mathematical formula}Comp(Π), is the following first-order sentence:{a mathematical formula} where
      </paragraph>
      <list>
       <list-item label="•">
        {a mathematical formula}P(x→)←Body1, …, {a mathematical formula}P(x→)←Bodyk are all the rules whose heads mention the predicate P;
       </list-item>
       <list-item label="•">
        {a mathematical formula}yi→ is the tuple of body variables in {a mathematical formula}P(x→)←Bodyi;
       </list-item>
       <list-item label="•">
        {a mathematical formula}Bodyiˆ is the conjunction of elements in {a mathematical formula}Bodyi by simultaneously replacing the occurrences of {a mathematical formula}not by ¬.
       </list-item>
      </list>
      <paragraph>
       It was shown that any stable model of a program Π must be a classical model of its completion, i.e. {a mathematical formula}Comp(Π). However, the converse does not hold in general. In this sense, Clark's completion fails to capture the stable model semantics.
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Definition 3">
       Ordered completionLet Π be a program. Ordered completion of Π, denoted by {a mathematical formula}OC(Π), is the set of following sentences:
      </paragraph>
      <list>
       <list-item label="•">
        For each intensional predicate P, the following sentences:{a mathematical formula}{a mathematical formula} where
       </list-item>
       <list-item label="•">
        for each triple of intensional predicates P, Q, and R (two or all of them might be the same) the following sentence:{a mathematical formula}
       </list-item>
      </list>
      <paragraph>
      ...
      <paragraph label="Proposition 1">
       Theorem 1, [4]Let Π be a program. Then, a finite{a mathematical formula}τ(Π)-structure is a stable model of Π if and only if it can be expanded to a model of{a mathematical formula}OC(Π).
      </paragraph>
      <paragraph>
     ...
     <section label="2.4">
      <section-title>
       The progression semantics for Datalog
      </section-title>
      <paragraph>
       A program is called a Datalog program if every predicate occurred in the negative part of some rule in the program is extensional. That is, the negative parts of rules in the program mention no intensional predicate, thus their values are fixed.
      </paragraph>
      <paragraph>
       The semantics for Datalog programs is usually defined in a progressional style as follows.
      </paragraph>
      <paragraph label="Definition 4">
       Datalog evaluation stageLet Π be a Datalog program and {a mathematical formula}D a structure of {a mathematical formula}τext(Π) (called the extensional database). Let {a mathematical formula}ΩΠ={Q1,…,Qn} be the set of all intensional predicates of Π. The t-th simultaneous evaluation stage of Π, denoted as {a mathematical formula}{Q1t,…,Qnt}, is defined inductively as follows:
      </paragraph>
      <list>
       <list-item label="•">
        for any {a mathematical formula}i,1≤i≤n, {a mathematical formula}Qi0=∅;
       </list-item>
       <list-item label="•">
        for any {a mathematical formula}i,1≤i≤n, {a mathematical formula}Qik+1=Qik∪{Head(r)η|there exists a rule r=Qi(x→)←Body∈Π and an assignment η such thatD∪Q1k∪…∪Qnk⊨Bodyˆ[η]}.
       </list-item>
      </list>
      <paragraph>
      ...
      <paragraph>
       Clearly, for any {a mathematical formula}Qi, the sequence {a mathematical formula}Qi0,Qi1,…,Qik,… is monotonic in the sense that {a mathematical formula}Qik⊆Qik+1 for any k. Hence, a convergence always exists on finite structures.
      </paragraph>
      <paragraph label="Definition 5">
       Intended valueLet Π be a Datalog program and {a mathematical formula}D a structure of {a mathematical formula}τext(Π). Let {a mathematical formula}Q∈ΩΠ be an intensional predicate. The intended value of Q on{a mathematical formula}Dfor Π, denoted by {a mathematical formula}Q∞(Π,D), is{a mathematical formula}
      </paragraph>
      <paragraph>
       Notice that Definition 5 can be extended for structures {a mathematical formula}D with arbitrary cardinality by using transfinite iteration. For an arbitrary cardinal number ϵ, we define
      </paragraph>
      <list>
       <list-item label="•">
        {a mathematical formula}Qiϵ=⋃ξ&lt;ϵQiξ∪{Head(r)η|there exists a rule r=Qi(x→)←Body∈Π and an assignment η such thatD∪Q1ξ∪…∪Qnξ⊨Bodyˆ[η]}.
       </list-item>
      </list>
      <paragraph>
    ...
    <section label="3">
     <section-title>
      A progression definition for normal logic programs
     </section-title>
     <paragraph>
     ...
     <section label="3.1">
      ...
      <paragraph label="Definition 7">
       Progressional stable modelLet Π be a normal program and {a mathematical formula}M a structure of {a mathematical formula}τ(Π). {a mathematical formula}M is called a progressional stable model of Π iff {a mathematical formula}M∞(Π)=M.
      </paragraph>
      <paragraph>
     ...
     <section label="3.2">
      <section-title>
       Progressional stable models = translational stable models
      </section-title>
      <paragraph>
    ...
    <section label="4">
     <section-title>
      Boundedness, recursion-freeness and loop-freeness
     </section-title>
     <paragraph>
     ...
     <section label="4.1">
      <section-title>
       Boundedness for normal logic programs
      </section-title>
      <paragraph>
      ...
      <paragraph label="Definition 8">
       Datalog boundednessA Datalog program Π is bounded if there exists a natural number k, such that for every extensional database {a mathematical formula}D, the evaluation stage of Π on {a mathematical formula}D is bounded within k steps, i.e., {a mathematical formula}Q∞=Qk for all intensional predicates Q in Π.
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Proposition 2">
       Let Π be a Datalog program. Then, Π is bounded underDefinition 9iff it is bounded underDefinition 8.
      </paragraph>
      <paragraph>
       As a consequence, some results in the Datalog literature can be directly applied under the context of ASP.
      </paragraph>
      <paragraph label="Proof">
       Checking boundedness for normal logic programs is undecidable.This assertion follows directly from Proposition 2 and the result that checking boundedness for Datalog programs is undecidable (see Theorem 2.5 in [19]).  □
      </paragraph>
     </section>
     <section label="4.2">
      <section-title>
       Recursion-freeness and loop-freeness
      </section-title>
      <paragraph>
      ...
      <paragraph label="Proposition 4">
       If Π is a recursion-free program, then{a mathematical formula}M∞(Π)=M1(Π)for any structure{a mathematical formula}Mof{a mathematical formula}τ(Π).
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Definition 11">
       Loop-freenessA program is said to be loop-free if it has no loop.
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Proposition 6">
       [12]Let Π be a loop-free program. Then, a{a mathematical formula}τ(Π)-structure{a mathematical formula}Mis a stable model of Π iff it is a model of{a mathematical formula}Comp(Π).
      </paragraph>
      ...
      <paragraph label="Proposition 7">
       A recursion-free program must be loop-free.
      </paragraph>
      <paragraph>
       However, the converse of Proposition 7 does not hold in general. For example, the following program{a mathematical formula} is loop-free but not recursion-free.
      </paragraph>
     </section>
     <section label="4.3">
      <section-title>
       On the relationships among boundedness, recursion-freeness and loop-freeness
      </section-title>
      <paragraph>
      ...
      <paragraph label="Proposition 8">
       A loop-free program must be bounded.
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Corollary 10">
       If a program is bounded, then it is equivalent to a loop-free program.
      </paragraph>
      <paragraph>
    ...
    <section label="5">
     ...
     <section label="5.1">
      <section-title>
       First-order definability of answer set programs
      </section-title>
      <paragraph>
       We start our discussions with a formal definition of first-order definability of normal logic programs.
      </paragraph>
      <paragraph label="Definition 12">
       First-order definabilityLet Π be a program and ϕ a first-order sentence of the signature {a mathematical formula}τ(Π). Let {a mathematical formula}C be a class of first-order structures. We say that ϕ defines Π on {a mathematical formula}C if the models of ϕ in {a mathematical formula}C are exactly the stable models of Π in {a mathematical formula}C.A program Π is said to be first-order definable on {a mathematical formula}C if there exists such a first-order sentence that defines Π.
      </paragraph>
      <paragraph>
       In this paper, we normally consider {a mathematical formula}C to be the class of all structures or the class of finite structures.
      </paragraph>
      <paragraph label="Example 6">
       Let us consider {a mathematical formula}ΠV again in Example 2. It can be verified that {a mathematical formula}ΠV is defined by the following sentence:{a mathematical formula}∀xy(Visits(x,y)↔(Interested(x,y)∧¬Busy(x)∨∃z(z≠x∧Visits(z,y)∧Attraction(y)∧¬Busy(x)))). □
      </paragraph>
      <paragraph>
      ...
      <paragraph label="Proposition 11">
       [13]If Π is a loop-free program, then{a mathematical formula}Comp(Π)defines Π on both arbitrary structures and finite structures.
      </paragraph>
      <paragraph>
     ...
     <section label="5.2">
      <section-title>
       Boundedness = first-order definability
      </section-title>
      <paragraph>
      ...
      <paragraph label="Theorem 2">
       Let Π be a program. The following four statements are equivalent on arbitrary structures.
      </paragraph>
      <list>
       <list-item label="1.">
        Π is bounded.
       ...
       <list-item label="2.">
        Π is equivalent to a recursion-free program.
       </list-item>
       <list-item label="3.">
        Π is equivalent to a loop-free program.
       </list-item>
       <list-item label="4.">
        Π is first-order definable.
       </list-item>
      </list>
      <paragraph>
    ...
    <section label="6">
     ...
     <list>
      ...
      <list-item label="•">
       the positive body of r is satisfied by the intended structure {a mathematical formula}M;
      </list-item>
      <list-item label="•">
       there exists at least one ground atom in the positive body of r, which is generated at the {a mathematical formula}t−1-th stage, and all other ground atoms in the positive body of r must be generated even earlier.
      </list-item>
     </list>
     <paragraph>
      Having explained our intuitions, we are now able to define the new translation from normal ASP to SMT. Again, for every intensional predicate P, we introduce an integer function {a mathematical formula}nP with the same arity.
     </paragraph>
     <paragraph label="Definition 13">
      Progression based completionLet Π be a program. The progression based completion of Π, written {a mathematical formula}PC(Π), is the following sentence{a mathematical formula} where
     </paragraph>
     <list>
      <list-item label="•">
       some notations, including {a mathematical formula}yi, {a mathematical formula}Bodyi and {a mathematical formula}Bodyiˆ, are borrowed from Definition 2, Definition 3. Once again, {a mathematical formula}Q(z→) ranges over all intensional atoms in the positive part of {a mathematical formula}Bodyi;
      </list-item>
      <list-item label="•">
       {a mathematical formula}succ and max stand for the successor function and the maximum function in arithmetic respectively.
      </list-item>
     </list>
     <paragraph>
     ...
     <paragraph label="Proof">
      Let Π be a program. Then,{a mathematical formula}PC(Π)⊨OC′(Π).This follows from the definitions since if {a mathematical formula}nP(x→)=succ(max({nQ(z→)})), then for all {a mathematical formula}nQ(z→), {a mathematical formula}nQ(z→)&lt;nP(x→).  □
     </paragraph>
     <paragraph>
   ...
   <appendices>
    <section label="Appendix">
     Proofs of Proposition 9 and Theorem 2
     <paragraph>
     ...
     <paragraph label="Lemma 5">
      [11]Let{a mathematical formula}Kbe a class of τ-structures which is first-order finitely axiomatizable.{sup:5}A least fixed-point formula is bounded on{a mathematical formula}Kiff it is defined by a first-order formula on{a mathematical formula}K.
     </paragraph>
     <paragraph>
     ...
     <paragraph>
      Let Π be a program. Let {a mathematical formula}{P1,…,Pn} be the set of intensional predicates of Π. Suppose that k is the maximal arity among all {a mathematical formula}Pi,(1≤i≤n). Let {a mathematical formula}0,1,…,n be {a mathematical formula}n+1 distinguishable new constants. Construct a new predicate P whose arity is {a mathematical formula}k+1. Let {a mathematical formula}ΠS be the program obtained from Π by simultaneously replacing each atom {a mathematical formula}Pi(ti→) in Π with {a mathematical formula}P(ti→,0,…,0,i), where the number of occurrences of 0 is equal to {a mathematical formula}k−|ti→|. We show that {a mathematical formula}ΠS simulates Π.
     </paragraph>
     <paragraph label="Lemma 6">
      Let Π be a program and{a mathematical formula}ΠSbe the program constructed above. Let{a mathematical formula}Mbe a structure of{a mathematical formula}τ(Π). We construct a structure{a mathematical formula}MSon{a mathematical formula}τext(Π)∪{P}such that
     </paragraph>
     <list>
      <list-item label="•">
       the domain of{a mathematical formula}MSis{a mathematical formula}M∪{0,1,…,n};
      </list-item>
      <list-item label="•">
       for all extensional predicates Q of Π,{a mathematical formula}QMS=QM;
      </list-item>
      <list-item label="•">
       for all constants c in Π,{a mathematical formula}cMS=cM;
      </list-item>
      <list-item label="•">
       for all intensional predicates{a mathematical formula}Pi,{a mathematical formula}Pi(a→)∈Miff{a mathematical formula}P(a→,0,…,0,i)∈MS.
      </list-item>
     </list>
     <paragraph label="Proof">
      This assertion follows from the constructions and definitions by induction on k.  □
     </paragraph>
     <paragraph>
      Lemma 6 shows that {a mathematical formula}ΠS can simulate Π in the sense that every intensional atom {a mathematical formula}Pi(ti→) in Π is associated with the intensional atom {a mathematical formula}P(ti→,0,…,0,i) in {a mathematical formula}ΠS.
     </paragraph>
     <paragraph>
